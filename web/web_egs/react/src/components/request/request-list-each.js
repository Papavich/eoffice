                        ...
                        <Col class='text-center table-col' sm={8} span={24}>
                            {
                                calendarItem.calendar_item_open.open ?
                                    <a href={`${URL.REQUEST.REQUEST_ADD.PATH}/${calendarItem.owner_id}/${calendarItem.calendar_id}/${calendarItem.level_id}/${calendarItem.semester_id}/${calendarItem.action.action_id}`}>
                                        <Tag class='clickable tag-success'>
