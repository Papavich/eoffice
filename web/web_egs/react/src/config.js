...
export const URL = {
    ...
    CALENDAR: {
        ...
        CALENDAR_INIT: {
            PATH: `${egs_base}/calendar/init`,
            GET_CALENDAR_ITEM_INIT: `${egs_base}/calendar-item/find-init`,
        },
        CALENDAR: {
            PATH: `${egs_base}/calendar/detail`,
    ...
    EVALUATION: {
        EVALUATION_ADD: {
            PATH: `${egs_base}/evaluation/add`,
            INSERT: `${egs_base}/evaluation/insert`
        },
        EVALUATION_LIST: {
            PATH: `${egs_base}/evaluation/list`,
            GET_EVALUATION: `${egs_base}/evaluation/get`,
    ...
    TODO: {
        TODO_ALL: {
            PATH: `${egs_base}/todo/list`,
            GET_TODO: `${egs_base}/todo/all`
        }
    },
    ADVISOR: {
        ADVISOR_LOAD: {
            PATH: `${egs_base}/advisor/work-load`,
