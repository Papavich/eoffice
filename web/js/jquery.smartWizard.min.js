...
! function (t, s, e, n) {
    ...
    t.extend(i.prototype, {
        ...
        _setToolbar: function () {
            ...
            var s = this.options.toolbarSettings.showNextButton !== !1 ? t("<button id='next-button'></button>").text(this.options.lang.next).addClass("btn btn-secondary sw-btn-next").attr("type", "button") : null,
                e = this.options.toolbarSettings.showPreviousButton !== !1 ? t("<button id='prev-button'></button>").text(this.options.lang.previous).addClass("btn btn-secondary sw-btn-prev").attr("type", "button") : null,
