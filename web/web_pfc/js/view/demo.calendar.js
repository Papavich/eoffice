				...
				****************************** **/
                ...
                select: function(start, end, allDay) {
                    ...
                    if(jQuery("#calendar").attr('data-modal-create') == 'true') {
                        ...
                        endtime 	= jQuery.fullCalendar.formatDate(end,'');
                        starttime 	= jQuery.fullCalendar.formatDate(start,'ddd, MMM d');
                        ...
                        BootstrapDialog.show({
                            ...
                            '<label class="fsize11 block margin-top-20">Time (EXAMPLE: 12:00 AM)</label>' +
                            '<input required type="time" class="calendar_event_input_add form-control" id="apptEventDescription" />' +

                            '<input required type="text" class="calendar_event_input_add form-control" id="apptEventTitle" placeholder="Event Title" />' +
                            '<textarea class="calendar_event_textarea_add form-control" id="apptEventDescription" placeholder="Detail" rows="3"></textarea>' +
                            ...
                            '',
                           // '<input required type="time" class="calendar_event_input_add form-control" id="apptEventDescription" />' +
                           // '<input required type="text" class="calendar_event_input_add form-control" id="apptEventTitle" placeholder="Content" />' +
                           ...
                           // '<div style="display: none" class="sky-form">' +
                           // '<div class="block inline-group">' +

                           // '<label class="radio"><input type="radio" name="calendar_event_color" value="bg-warning" checked="checked" /><i></i> <span class="text-primary">Default</span></label>' +
