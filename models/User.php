...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['username', 'email', 'password_hash', 'auth_key', 'created_at', 'updated_at', 'type', 'student_id', 'person_id'], 'required'],
            [['confirmed_at', 'blocked_at', 'created_at', 'updated_at', 'flags', 'last_login_at', 'status', 'student_id', 'person_id'], 'integer'],
