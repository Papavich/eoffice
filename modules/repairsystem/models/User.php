...
class User extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['username', 'email', 'password_hash', 'auth_key', 'created_at', 'updated_at', 'fname', 'lname', 'tel'], 'required'],
    ...
    {
        return $this->hasMany(RepairDescription::className(), ['id' => 'id']);
    }
