...
/**
 * This is the model class for table "eoffice_central.reg_course".
 *
 ...
 */
class EofficeCentralRegCourse extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'eoffice_central.reg_course';
    }
    ...
    public function rules()
    {
        return [
            [['COURSEID'], 'required'],
            [['COURSEID', 'COURSECODE'], 'string', 'max' => 10],
            [['REVISIONCODE', 'COURSEUNICODE', 'COURSENAME', 'COURSENAMEENG', 'COURSEABB', 'COURSEABBENG', 'CREDITMIN', 'CREDITMAX', 'CREDITTOTAL', 'PERIODTOTAL', 'CREDIT1', 'CREDIT2', 'CREDIT3', 'PERIOD1', 'PERIOD2', 'PERIOD3', 'STUDYCODE1', 'STUDYCODE2', 'STUDYCODE3', 'FEECHARGE', 'FEESEMESTER1', 'FEESEMESTER2', 'FEESEMESTER3', 'COURSETYPE', 'COURSESTATUS', 'DEFAULTCLASSSTATUS', 'GRADEMODE', 'FACULTYID', 'DEPARTMENTID', 'CREATEDATETIME', 'CREATEUSERID', 'LASTUPDATEDATETIME', 'LASTUPDATEUSERID', 'COURSEUNIT', 'COURSEGROUP', 'OPENDATE', 'CLOSEDATE', 'FEESEMESTER4', 'PREREQUISITENOTE', 'DESCRIPTION3', 'DESCRIPTIONENG3', 'OWNERLEVELID', 'EVALUATEID', 'CLASSEVALUATEID'], 'string', 'max' => 255],
            [['DESCRIPTION1', 'DESCRIPTION2', 'DESCRIPTIONENG1', 'DESCRIPTIONENG2'], 'string', 'max' => 500],
            [['COURSEID'], 'unique'],
        ];
    }
