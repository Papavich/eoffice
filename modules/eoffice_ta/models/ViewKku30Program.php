 ...
 */
class ViewKku30Program extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['program_id', 'program_nameeng'], 'string', 'max' => 10],
    ...
    {
        return $this->hasMany(Kku30Section::className(), ['section_no' => 'section_no', 'subject_id' => 'subject_id', 'subject_version' => 'subject_version', 'term_id' => 'subopen_semester', 'year_id' => 'subopen_year'])->viaTable('kku30_section_program', ['program_id' => 'program_id', 'program_class' => 'program_class']);
    }
}
