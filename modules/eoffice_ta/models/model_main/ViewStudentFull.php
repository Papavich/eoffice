...
/**
 * This is the model class for table "eoffice_main.view_student_full".
 *
 ...
 */
class ViewStudentFull extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'eoffice_main.view_student_full';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['RELIGIONNAME', 'RELIGIONNAMEENG', 'ADMITSEMESTER', 'ADMITACADYEAR'], 'string', 'max' => 45],
        ];
    }
