...
class EofficeMainPerson extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['person_card_id', 'person_current_district', 'person_current_amphur', 'person_current_province', 'person_current_zipcode', 'person_home_district', 'person_home_amphur', 'person_home_province', 'person_home_zipcode', 'person_type', 'major_id', 'person_religion_id', 'person_nation_id'], 'integer'],
            [['person_citizen_id', 'prefix_id', 'person_current_district', 'person_current_amphur', 'person_current_province', 'person_current_zipcode', 'person_home_district', 'person_home_amphur', 'person_home_province', 'person_home_zipcode', 'person_type', 'academic_positions_id', 'department_id', 'major_id', 'faculty_id', 'person_religion_id', 'person_nation_id'], 'required'],
