...
/* @var $model app\modules\eoffice_ta\models\TaEquationSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="ta-equation-search">
    ...
    <?= $form->field($model, 'ta_equation_id') ?>

    <?= $form->field($model, 'ta_equation_name') ?>

    <?= $form->field($model, 'ta_equation_detail') ?>
