    ...
    <div class="panel-body">
            ...
            <?php
               foreach  ($model as $item) {
                   ...
                   $comments = TaComment::find()->where(['subject_id'=>$item->subject_id,'ta_id'=>$item->person_id,
                ...
                <div class="panel-body">
                    ...
                    */
                    ...
                    $modelTeacher2 = ViewPisOfficerClass::findOne(
                        ['OFFICERNAME'=>$person->person_fname_th,'OFFICERSURNAME'=>$person->person_lname_th]
                    );  // $modelTeacher2->OFFICERNAME;$modelTeacher2->OFFICERSURNAME;$modelTeacher2->COURSECODE;
