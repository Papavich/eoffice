                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-vertical-middle nomargin">
                            ...
                            <tr class="info">
                                ...
                                <th class="text-center"><?=$label_teacher?></th>
                            ...
                            foreach ($model as $item){
                                   ...
                                   <i class="glyphicon glyphicon-ok"></i> ร้องขอผู้ช่วยสอนแล้ว</span>
                                        ...
                                        <td class="text-center">
                                            <?php echo Html::a(Html::tag('i', '',
                                                ...
                                                ['ta-request/update','s' => $subj_id,'ver'=>$ver,'t'=>$term,'y'=>$year],
                                                ['class' => 'btn btn-reveal btn-warning ']) ?>
                                            <?php echo  Html::a(Html::tag('i', '',
                                                    ['class' => 'glyphicon glyphicon-briefcase']) . 'ภาระงาน', //workload
                                                ['ta-workload-teacher/index','s' => $subj_id,'ver'=>$ver,'t'=>$term,'y'=>$year],
                                                ['class' => 'btn btn-brown']) ?>
                                        </td>
                                        <!--  ///////////////////////////////////////////////////////////////  -->
                                    <?php   }else{?>
                               ...
                               <i class="fa fa-exclamation-triangle"></i> ยังไม่ร้องขอผู้ช่วยสอน</span>
                                        </td>
                                        <!--  ///////////////////////////////////////////////////////////////  -->
                                        <td class="text-center">
                                            <?php echo  Html::a(Html::tag('i', '',
                                                    ['class' => 'glyphicon glyphicon-plus-sign']) . $label_req,
                                                ['ta-request/create', 's' => $subj_id,'ver'=>$ver,'t'=>$term,'y'=>$year],
                                                ['class' => 'btn btn-blue ']) ?>
                                        </td>
                                        <!--  ///////////////////////////////////////////////////////////////  -->
                                    <?php }?>
