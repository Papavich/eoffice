...
<div class="navbar navbar-default">
    <div class="navbar-header">
        ...
        <?= Menu::widget([
            'items' => [
                ['label' => 'รายการชั่วโมงปฏิบัติงานที่ยังไม่ตรวจสอบ', 'url' => ['check-working-by-ta'/*,s=342233&ver=1&t=2&y=2560*/]],
            ...
            <div class="panel-heading">
                ...
                ?>
							<span class="title elipsis size-20"><!-- panel title -->
								<strong>รายการชั่วโมงปฏิบัติงานที่ยังไม่ตรวจสอบ</strong> วิชา <strong class="text-blue">
                                ...
                                <tr>
                                  ...
                                  //   $register = TaRegister::find()->where(['subject_id'=>$subj_id,'subject_version'=>$ver,'term'=>$term,'year'=>$year])->all();
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?php  }elseif($item->active_status==TaWorking::STATUS_NEW){?>
                                                <strong style="color: #f39a0d" class="size-13">
                                                    New<i class="glyphicon glyphicon-certificate">
                                                    </i></strong>
                                        <?php  }}if (empty($item->active_status)){?>
