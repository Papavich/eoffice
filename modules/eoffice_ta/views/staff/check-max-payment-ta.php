...
<div class="panel-body">
    ...
    <div id="panel-1" class="panel panel-default">
        ...
        <tr > <!-- class="btn-aqua"-->
          ...
          <!--  <th width="2%" rowspan = 2><center>ดำเนินการ</center></th> -->
        </tr>
        <tr>
            <td class="text-center"><strong>จำนวนนักศึกษา</strong> </td>
            <td  class="warning text-center" ><strong>กรอบเงิน</strong></td>
            <td class="text-center"><strong>จำนวนนักศึกษา</strong></td>
            <td class="warning text-center"><strong>กรอบเงิน</strong></td>
        </tr>
        </thead>
            ...
            <tr class="odd gradeX">
                ...
                <td class="warning text-center">
                    ...
                    <strong style="color: limegreen" class="size-13">
                        ...
                        if(($A>0 )&& ($B>0)){
                            $PaymentMax = $Calculate->getEstimatePaymentMaxALL($subj_id,$ver,$term,$year,$countEn_normal);
                            echo Yii::$app->formatter->asDecimal($PaymentMax);
                        }elseif ($B==0) {
                            $PaymentMax = $Calculate->getEstimatePaymentMaxLec($subj_id, $ver, $term, $year, $countEn_normal);
                            echo Yii::$app->formatter->asDecimal($PaymentMax);
                        }elseif ($A==0) {
                            $PaymentMax = $Calculate->getEstimatePaymentMaxLab($subj_id, $ver, $term, $year, $countEn_normal);
                            echo Yii::$app->formatter->asDecimal($PaymentMax);
                        }else{
                ...
                <td class="text-center">
                        ...
                        <?php echo  $countEn_vip?>
                            ...
                            <td class="warning text-center">
                               ...
                               <strong style="color: limegreen" class="size-13">
                                ...
                                $B =  (int)substr($credit, 5, 1); //B
                                if(($A>0 )&& ($B>0)){
                                  $PaymentMax = $Calculate->getEstimatePaymentMaxALL($subj_id,$ver,$term,$year,$countEn_vip);
                                    echo Yii::$app->formatter->asDecimal($PaymentMax);
                                }elseif ($B==0) {
                                    $PaymentMax = $Calculate->getEstimatePaymentMaxLec($subj_id, $ver, $term, $year, $countEn_vip);
                                    echo Yii::$app->formatter->asDecimal($PaymentMax);
                                }elseif ($A==0) {
                                    $PaymentMax = $Calculate->getEstimatePaymentMaxLab($subj_id, $ver, $term, $year, $countEn_vip);
                                    echo Yii::$app->formatter->asDecimal($PaymentMax);
                                }else{
                                    echo 'ข้อมูลชั่วโมงหน่ายกิตจากระบบผิดพลาด';
                                }
                    ...
                    <!--    <td class="text-center">   -->
                            <?php
                            /*echo Html::a(Html::tag('i',' บันทึกกรอบเงิน',
                                ['class' => 'glyphicon glyphicon-plus size-16']),
                                ['ta-payment/add',
                                   's'=>$subj_id,'ver'=>$ver,'t'=>$term,'y'=>$term,
                                    'vip'=>$countEn_vip,'nor'=>$countEn_normal,
                                   'c'=>$credit,
