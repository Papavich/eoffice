...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2018 at 06:32 PM
...
('342233', '1479900299285', '2/2560', '2560', 'RG-FCH', '', '', '', '', 10, '2018-02-11 08:29:31', NULL, NULL);
...
ALTER TABLE `ta_workload_teacher`
  ADD PRIMARY KEY (`subject_id`,`term`,`year`,`ta_wload_teacher_id`),
  ADD KEY `fk_ta_workload_teacher_kku30_section1_idx` (`section`),
...
--
ALTER TABLE `ta_workload_teacher`
  ADD CONSTRAINT `fk_ta_workload_teacher_kku30_section1` FOREIGN KEY (`section`) REFERENCES `kku30_section` (`section_no`) ON DELETE NO ACTION ON UPDATE NO ACTION,
