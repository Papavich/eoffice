...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2018 at 10:28 AM
...
INSERT INTO `kku30_subject_open` (`subject_id`, `subject_version`, `subopen_semester`, `subopen_year`, `amount_sec`, `teacher`) VALUES
('322131', 1, '2/2560', '2560', 2, '1224500006600'),
('322437', 1, '2/2560', '2560', 2, '1234500006654'),
('342131', 1, '2/2560', '2560', 4, '1224500006600'),
('342233', 1, '2/2560', '2560', 3, '1224500006655');
...
(1, 'TA-01', 'เอกสารสมัครTA', 'รายชื่อนักศึกษาฝึกงาน-3_2559.xlsx', '2', NULL, NULL, NULL, NULL),
...
(6, 'เริ่มปฏิบัติงานได้ตั้วแต่วันที่ 31 กรกฏาคม 2560 และจัดทำแบบบันทึกการปฏิบัติงาน (TA-06)', 'รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด', '4ca3a7f85b06af08afaf93d42e216dfb.jpg', '401664.jpg', '', 1, 1, 'PROP-FAIL', NULL, NULL, NULL, NULL),
(12, 'ประกาศ2', 'รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด', '326008.jpg', '7041559-natural-pictures-wallpaper.jpg', '', 2, 2, 'RG-CH', NULL, NULL, NULL, NULL),
(13, 'เริ่มปฏิบัติงานได้ตั้วแต่วันที่ 31 กรกฏาคม 2560 และจัดทำแบบบันทึกการปฏิบัติงาน (TA-06)', '  รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด', '7041559-natural-pictures-wallpaper.jpg', 'amazing-hd-city-image.jpg', '', 1, 2, 'PROP-FAIL', NULL, NULL, NULL, NULL),
...
('322131', '1479900299285', '2/2560', '2560', 'RG-TA', '', '5555555555', '', '', 10, '2018-01-19 10:22:53', NULL, NULL),
('342233', '1479900299285', '2/2560', '2560', 'RG-TA', '55555555555555555555', '', '', '', NULL, NULL, NULL, NULL),
('342233', '1487799564230', '2/2560', '2560', 'RG-TA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `ta_request` (
  ...
  `property_grade` varchar(1) DEFAULT NULL,
...
--
-- Table structure for table `ta_request_subject`
--

CREATE TABLE `ta_request_subject` (
  `person_id` varchar(15) NOT NULL,
  `subject_id` varchar(10) NOT NULL,
  `term_id` varchar(10) NOT NULL,
  `year` varchar(10) NOT NULL
...
CREATE TABLE `ta_schedule` (
  `ts_schedule_id` int(11) NOT NULL,
...
ALTER TABLE `kku30_subject_open`
  ...
  ADD KEY `fk_teacher_subj_idx` (`teacher`),
...
ALTER TABLE `ta_request`
  ADD PRIMARY KEY (`person_id`,`term_id`,`year`),
...
--
-- Indexes for table `ta_request_subject`
--
ALTER TABLE `ta_request_subject`
  ADD PRIMARY KEY (`subject_id`,`term_id`,`year`,`person_id`),
  ADD KEY `fk_term_req2_idx` (`term_id`),
  ADD KEY `fk_year_req2_idx` (`year`),
  ADD KEY `fk_person_req2_idx` (`person_id`);
...
ALTER TABLE `ta_schedule`
  ADD PRIMARY KEY (`ts_schedule_id`),
...
ALTER TABLE `ta_work_load`
  ADD PRIMARY KEY (`person_id`,`subject_id`,`term_id`,`year_id`),
...
ALTER TABLE `ta_work_plan`
  ...
  ADD KEY `fk_person_wp1_idx` (`person_id`,`subject_id`,`term_id`,`year_id`);
...
--
ALTER TABLE `ta_news`
  MODIFY `ta_news_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `ta_schedule`
  MODIFY `ts_schedule_id` int(11) NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `kku30_subject_open`
  ...
  ADD CONSTRAINT `fk_teacher_subj` FOREIGN KEY (`teacher`) REFERENCES `person` (`person_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `ta_payment`
  ...
  ADD CONSTRAINT `fk_subj_bud1` FOREIGN KEY (`subject_id`) REFERENCES `ta_request_subject` (`subject_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `ta_request`
  ...
  ADD CONSTRAINT `fk_term_req1` FOREIGN KEY (`term_id`) REFERENCES `term` (`term_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_year_req1` FOREIGN KEY (`year`) REFERENCES `term` (`year`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `ta_request_subject`
--
ALTER TABLE `ta_request_subject`
  ADD CONSTRAINT `fk_person_req2` FOREIGN KEY (`person_id`) REFERENCES `ta_request` (`person_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_subj_req2` FOREIGN KEY (`subject_id`) REFERENCES `kku30_subject_open` (`subject_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_term_req2` FOREIGN KEY (`term_id`) REFERENCES `kku30_subject_open` (`subopen_semester`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_year_req2` FOREIGN KEY (`year`) REFERENCES `kku30_subject_open` (`subopen_year`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `ta_work_plan`
  ADD CONSTRAINT `fk_person_wp1` FOREIGN KEY (`person_id`,`subject_id`,`term_id`,`year_id`) REFERENCES `ta_work_load` (`person_id`, `subject_id`, `term_id`, `year_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
