...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 27, 2018 at 12:25 PM
...
(1, 'TA-01', 'ฟอร์มเอกสารสมัครTA', 'รายชื่อนักศึกษาฝึกงาน-3_2559.xlsx', '2', NULL, NULL, NULL, NULL),
...
(13, 'เริ่มปฏิบัติงานได้ตั้วแต่วันที่ 31 กรกฏาคม 2560 และจัดทำแบบบันทึกการปฏิบัติงาน (TA-06)', '  รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด', 'bnk48.jpg', 'amazing-hd-city-image.jpg', '', 1, 2, 'PROP-FAIL', NULL, NULL, NULL, NULL),
...
INSERT INTO `ta_request` (`person_id`, `term_id`, `year`, `degree_bachelor`, `degree_master`, `degree_doctorate`, `amount_ta_all`, `request_note`, `property_grade`, `property_text`, `ta_type_work_id`, `ta_status_id`, `crby`, `crtime`, `udby`, `udtime`) VALUES
('1224500006600', '2/2560', '2560', 9, NULL, NULL, NULL, '', 'B', '', 'C&L', 'RQ-TA', NULL, '2018-01-24 08:39:10', NULL, NULL);
...
--
ALTER TABLE `ta_news`
  MODIFY `ta_news_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
