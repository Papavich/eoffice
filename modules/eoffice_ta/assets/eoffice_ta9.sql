...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2018 at 02:50 PM
...
INSERT INTO `ta_news` (`ta_news_id`, `ta_news_name`, `ta_news_detail`, `ta_news_img`, `ta_news_imgs`, `ta_news_url`, `ta_documents_id`, `ta_status`, `crby`, `crtime`, `udby`, `udtime`) VALUES
(1, 'แจ้งผู้ช่วยสอนฯ ทุกท่าน', '  รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด รายละเอียด', '20507357_1931971860407056_8867494667348101211_o.jpg', '497514917.jpg,ABN-updated-details.png,icon-professionals.png', '', 1, 'RG-TA', NULL, NULL, NULL, NULL);
...
('322352', '563020957', '2/2560', '2560', 'RG-FCH', '', '', '', '', NULL, '2018-02-16 14:35:26', NULL, NULL),
('322352', '573020749', '2/2560', '2560', 'RG-CH', '', '', '', '', NULL, '2018-02-16 14:34:54', NULL, NULL),
('322437', '573020749', '2/2560', '2560', 'RG-TA', '', '', '', '', NULL, '2018-02-16 14:34:58', NULL, NULL);
...
('322437', '2/2560', '2560', 3, NULL, NULL, NULL, '', '1', '', 'L', 'RQ-TA', 9, '2018-02-16 14:33:58', NULL, NULL),
...
('W-S01-322352-2/2560', '01', '322352', '2/2560', '2560', 'C', 'RQ-TA', '14:00:00', '17:00:00', '2.0', '1.0', NULL, NULL, NULL, NULL, NULL, NULL),
...
--
ALTER TABLE `ta_news`
  MODIFY `ta_news_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `ta_register`
  ADD CONSTRAINT `fk_ta_regis1_req1` FOREIGN KEY (`subject_id`,`term`,`year`) REFERENCES `ta_request` (`subject_id`, `term_id`, `year`) ON DELETE NO ACTION ON UPDATE NO ACTION,
