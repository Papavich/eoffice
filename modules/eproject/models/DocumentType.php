...
/**
 * This is the model class for table "epro_document_type".
 *
 * @property integer $id
...
class DocumentType extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'crtime' => 'Crtime',
            'udtime' => 'Udtime',
            'name' => \app\modules\eproject\controllers::t('label','Name'),
        ];
    }
    ...
    {
        return $this->hasMany(ProjectDocument::className(), ['document_type_id' => 'id']);
    }
}
