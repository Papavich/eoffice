...
//                    ['label' => controllers::t( 'menu', 'Edit Project' ), 'url' => ['project/edit'], 'visible' => $userType == AuthHelper::TYPE_STUDENT],
                ...
                ]],['label' => '<i class="main-icon fa fa-users"></i>  <span>' . controllers::t( 'menu', 'Exam Committee' ) . '</span>', 'url' => ['examination/board'], 'visible' => $userType == AuthHelper::TYPE_STUDENT || $userType == AuthHelper::TYPE_TEACHER || $userType == AuthHelper::TYPE_ADMIN],
...
//                    ]],
                    ['label' => '<i class="main-icon	fa fa-dashboard"></i>  <span>' . controllers::t( 'menu', 'Dashboard' ) . '</span>', 'url' => ['admin-dashboard/index']],
                    ['label' => '<i class="main-icon fa fa-sticky-note-o"></i>  <span>' . controllers::t( 'menu', 'Subject Management' ) . '</span>', 'url' => ['admin-subject/document-type']],
