...
?>
<?php foreach (\app\modules\eproject\models\DocumentType::find()->all() as $documentType){?>
    ...
    <div id="panel-misc-portlet-r1" class="panel panel-clean ">
        ...
        <div class="panel-body">
            <div class="row" style="font-weight: bold">
                <div class="col-xs-12"><?=controllers::t( 'label', 'Document' )?>
            ...
            <div class="row" style="margin-top:-10px">
                <div class="col-xs-4">
                    <?php foreach ($data[$documentType->id] as $item) { ?>
                ...
                <div class="col-xs-3"></div>
                <div class="col-xs-2">
                    <a href="#" onclick="updateDocumentType(<?=$documentType->id?>,0)" class="btn btn-success btn-xs" data-toggle="modal"
                        ...
                        <div id="jtab1_nobg" class="tab-pane active">
                            ...
                            <div class="form-group">
                                <div class="fancy-file-upload fancy-file-info">
                                    ...
                                    <input type="text" class="form-control" placeholder=" (docx, doc, xls, xlsx, png, jpg, pdf, ppt, pptx)" readonly=""/>
