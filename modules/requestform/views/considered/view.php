...
$this->title = 'คำร้องที่ผ่านการอนุมัติแล้ว';
...
<div class="test-create">
    ...
    <div class="col-md-9 col-lg-9 ">
        ...
        echo $form->field($model, 'approve_status')->dropDownList(
            [$approve_status], ['disabled' => 'disabled']
        ); ?>

        <?= $form->field($model, 'approve_comment')->textarea(['rows' => '6','value' => $approve_comment,'readonly' => true]) ?>
