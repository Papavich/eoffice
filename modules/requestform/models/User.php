...
class User extends \yii\db\ActiveRecord
{
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getReqValues()
    {
        return $this->hasMany(ReqValue::className(), ['id' => 'id']);
    }
    ...
    {
        return $this->hasMany(Studentreg::className(), ['user_id' => 'id']);
    }
