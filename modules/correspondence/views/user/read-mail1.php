            ...
            <div class="box box-primary" style="color: black">
                ...
                <div class="box-body no-padding">
                    <div class="mailbox-read-info">
                        <h3 style="color: black">รับสมัครคัดเลือกบุคคลเพื่อรับทุนรัฐยาลตามความต้องการของส่วนราชการ ประจำปีงบประมาณ พ.ศ.2553</h3>
                        <h5 style="color: black">จาก: correspondence@example.com
                            <span class="mailbox-read-time">28 เมษายน 2553 15:30:00</span></h5>
                    </div>
                    <!-- /.mailbox-read-info -->
                    ...
                    <div class="mailbox-read-message">
                        ...
                        <div class="col-lg-7">
                            <iframe width="600px" height="850px"
                                    src="<?= Yii::getAlias('@webword').'/style/doc2.pdf';?>" frameborder="0"></iframe>
                        </div>

                        <p><b>เลขที่รับเข้า :</b> 2220</p>
                        <p><b>วันที่รับเข้า : </b>28 เมษายน 2553 15:30:00</p>
                        <p><b>ลงวันที่(หนังสือ) :</b> 28 เมษายน 2553</p>
                        <p><b>เลขที่(หนังสือ):</b> นร 1004 1/ว973</p>
                        <p><b>ชั้นความลับ :</b> ปกติ</p>
                        <p><b>ชั้นความเร็ว :</b> ปกติ</p>
                        <p><b>ชื่อเรื่อง:</b> รับสมัครคัดเลือกบุคคลเพื่อรับทุนรัฐยาลตามความต้องการของส่วนราชการ ประจำปีงบประมาณ พ.ศ.2553</p>
                        <p><b>ส่งมาจาก:</b> ศูนย์สรรหาและเลือกสรร กลุ่มบริหารการสอบและระบบทุน</p>
                        <p><b>ประเภทหนังสือ :</b> หนังสือภายในอก</p>
                        <p><b>สถานที่เก็บต้นฉบับ :</b> สถาบันการศึกษา</p>
                        ...
                        <p><b>ส่งถึง : </b> <br>
                            สถาบันการศึกษา &nbsp สถานะ : <span style="color: green">อ่านแล้ว</span><br>
                                          ...
                                          <div class="panel panel-default arrow left">
                                              ...
                                              <div class="panel-body">
                                                  <header class="text-left">
                                                      ...
                                                      <time class="comment-date" datetime="16-12-2014 01:05"><i
                                                                  class="fa fa-clock-o"></i> 28 เมษายน 2553 17:15
                                                      </time>
                                                  </header>
                                                  <div class="comment-post">
                                                      <p>
                                          ...
                                          <div class="panel panel-default arrow left">
                                              ...
                                              <div class="panel-body">
                                                  <header class="text-left">
                                                      ...
                                                      <time class="comment-date" datetime="16-12-2014 01:05"><i
                                                                  class="fa fa-clock-o"></i> 28 เมษายน 2553 17:33
                                                      </time>
                                                  </header>
                                                  <div class="comment-post">
                                                      <p>
                                    ...
                                    <div class="col-md-2 col-sm-2 hidden-xs">
                                        <figure class="thumbnail">
                                            <img class="img-responsive"
                                                 src="https://openclipart.org/image/2400px/svg_to_png/202776/pawn.png"
                                                 width="80"/>
                                            <figcaption class="text-center">สถาบันการศึกษา</figcaption>
                                        </figure>
                                    </div>
                                    <div class="col-md-10 col-sm-10">
                                        <div class="panel panel-default arrow left">
