...
app\modules\correspondence\assets\AppAsset::register($this);
...
<?php $this->beginPage() ?>
    ...
    <script>
        ...
        const phoneNumberMustBeNumbersOnly = "<?=controllers::t('menu','Phone number must be numbers only!' )?>";
        const giveCorrectDate = "<?=controllers::t('menu','Please give correct date !')?>";
