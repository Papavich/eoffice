                            ...
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    echo Html::a("<i class=\"fa fa-edit\"></i><span>" . controllers::t('menu', 'Edit') . "</span>",
                                        ['staff-receive/edit-receive-form?id=' . $rows['doc_id']], ['class' => 'btn btn-3d btn-xs btn-reveal btn-blue btnw']);
                                    ...
                                    if (!$rows->cmsInboxes) { ?>
                                        ...
                                        <?php
                                    } elseif ($rows->cmsInboxes && $rows->check->check_id != 2) { ?>
                                        <a href="#" onclick="redirectDeleteRoll('<?= $rows['doc_id'] ?>')"
                                           class="btn btn-3d btn-xs btn-reveal btn-yellow btnw confirmCancelDocument">
