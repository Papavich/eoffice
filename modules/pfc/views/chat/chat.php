...
<link href="<?= Yii::$app->homeUrl ?>web_pfc/css/chat.css" rel="stylesheet" type="text/css"/> <!-- css ของ chat -->
    ...
    (function () {
        ...
        $(function () {
            ...
            $('.send_message').click(function (e) {
                $.post('<?= Yii::$app->homeUrl ?>pfc/chat/chat_send', {msg: getMessageText()}, function () {});
...
//                $('.messages').load('<?//= Yii::$app->homeUrl ?>//pfc/chat/chat_msg');

                $.getJSON('<?= Yii::$app->homeUrl ?>pfc/chat/chat_msg', function (data) {
