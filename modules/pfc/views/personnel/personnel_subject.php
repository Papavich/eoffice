...
?>
    ...
    <div class="panel-body">
        <div class="padding-20">
            ...
            <form action="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_subject_connect" method="post" name="myForm"
                ...
                <div class="fancy-form fancy-form-select" style="margin-top: 15px">
                    <select class="form-control select2" name="subject" >
                        ...
                        <?php foreach ($subject as $subjects){ ?>
                            <option value="<?= $subjects->subjects_id ?>"><?= $subjects->subjects_code ?> : <?= $subjects->subjects_name_thai ?></option>
                        <?php } ?>
                    </select>
                ...
                <div class="row" style="margin-top: 20px;">
                    <div class="col-md-12">
                        <button type="submit" href="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_subject_connect"
                                class="btn btn-green" name="save" value="save">
                            สร้างกำหนดการ
                        </button>
                        <a type="button" href="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_type" class="btn btn-red" >ถอยกลับ</a>
                    </div>
                            ...
                            foreach ($subject as $subjects){
                                if($gantt_processn->subjects_id == $gantt_processn->subjects_id){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_gantt_type_add?subject_choose=<?= $subjects->subjects_id ?>&type_degree=<?= $type_degree ?>"
                                               class="label label-default">แก้ไขกำหนดการ
                                            </a>

                                            <a href="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_subject_delete?gantt_type=<?= $gantt_processn['process_gantt_tpye_id'] ?>&type_degree=<?= $type_degree ?>"
