...
?>
    ...
    <div class="panel-body">
        <div class="padding-20">
            ...
            <form action="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_gantt_type_add" method="post" name="myForm"
                ...
                <div class="row"
                    ...
                    <div class="col-md-12">
                        <button type="submit" href="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_gantt_type_add" class="btn btn-green">ตกลง</button>
                        <a type="button" href="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_subject?type_degree=<?= $type_degree ?>" class="btn btn-default" data-dismiss="modal">ถอยกลับ</a>
                    </div>
                </div>
            </form>
        </div>
