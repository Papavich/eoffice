            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="box danger">
                        ...
                        <a href="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_subject?type_degree=1"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method=post action="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_upload" enctype="multipart/form-data">
