        ...
        <div id="panel-1" class="panel panel-default">
            <div class="panel-heading">
                <span class="title elipsis">
                    ...
                    <small class="size-12 weight-300 text-mutted hidden-xs"><?= $value->name_en ?></small>
                </span>
            </div>
        ...
        <!-------------------------------------------------------- BOX ------------------------------------------------------------------>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="box warning">
                    ...
                    <a href="<?= Yii::$app->homeUrl ?>pfc/process/process?project_id=<?= $value->id ?>&type=2&id=<?= $session['pfc_id'] ?>&type_degree=<?= $type_degree ?>&process_gantt_type_code=<?= $process_gantt_type_code ?>"
            ...
            <div class="col-md-3 col-sm-6">
                <div class="box danger">
                    ...
                    <?php if($personnel_file != null){ ?>
                        <a href="<?= Yii::$app->homeUrl ?>pfc/personnel/personnel_download?fileupload=<?= $personnel_file[0]->personnel_file_pro ?>"
