        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    $sql = 'SELECT * FROM eolm_approvalform_has_student left join eoffice_central.view_student_full on eolm_approvalform_has_student.STUDENTID = eoffice_central.view_student_full.STUDENTID where eolm_approvalform_has_student.eolm_app_id='.$i ?>
