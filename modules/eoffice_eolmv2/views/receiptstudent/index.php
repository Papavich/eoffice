...
<div class="eolm-receipt-student-index">
    ...
    <p>
        <?= Html::a('<i class="	fa fa-plus"></i> '.\app\modules\eoffice_eolmv2\controllers::t( 'menu','Create a Receipt for Student'), '@web/eoffice_eolmv2/receiptstudent/create?id='.$_GET['id'], ['class'=>'btn btn-social btn-success'],[
