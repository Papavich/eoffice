                ...
                'buttons'=>[
                    ...
                    'loan' => function ($url, $model,$key) {
                        $mo = EolmRepay::find()->where('eolm_app_id='.$model->eolm_app_id)->one();
                            ...
                            if(empty($mo)){
                                return Html::a('<i class="fa fa-pencil-square-o"></i> บันทึกคืนเงินยืม', '@web/eoffice_eolmv2/repayform/create?id='.$model->eolm_app_id, ['class'=>'btn btn-block btn-social btn-success'],[
                                ...
                                if ($mo2->eolm_status_id=1){
                                    return Html::a('<i class="fa fa-pencil-square-o"></i> แก้ไขบันทึกคืนเงินยืม', '@web/eoffice_eolmv2/repayform/update?eolm_app_id='.$model->eolm_app_id.'&eolm_repay_date='.$mo->eolm_repay_date, ['class'=>'btn btn-block btn-social btn-warning'],[
