            ...
            <tr class="room-item warning">
                <td class="center">
                    <div class="row">
                        ...
                        ->dropDownList(
                            \yii\helpers\ArrayHelper::map(\app\modules\eoffice_eolmv2\models\EolmBorrowingplansType::find()->asArray()->all(), 'eolm_bor_type_id', 'eolm_bor_type_name')
                        )->label(false) ?>
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <?= $form->field($modelDetail, "[{$indexBorrow}][{$indexDetail}]eolm_bor_detail", [
                        'inputOptions' => [
                            'placeholder' => controllers::t( 'label', 'Details of vehicle'),
                            'class'=>'form-control',
                        ],
