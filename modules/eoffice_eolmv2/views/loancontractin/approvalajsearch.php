            ...
            [
                ...
                'buttons'=>[
                    ...
                    'loan' => function ($url, $model,$key) {
                        ...
                        if(empty($mo)){
                            return Html::a('<i class="	fa fa-plus"></i> ทำสัญญา', '@web/eoffice_eolmv2/loancontractin/create?id='.$model->eolm_app_id, ['class'=>'btn btn-block btn-social btn-success'],[
                                'title' => Yii::t('app', 'ทำสัญญา')
                            ]);
                        }else{
                            return Html::a('<i class="fa fa-pencil-square-o"></i> แก้ไขสัญญา', '@web/eoffice_eolmv2/loancontractin/update?id='.$model->eolm_app_id, ['class'=>'btn btn-block btn-social btn-warning'],[
