...
use app\modules\eoffice_eolmv2\assets;
    ...
    <nav id="sideNav"><!-- MAIN MENU -->
        ...
        <?php echo Menu::widget( [
            'items' => [
                ...
                ['label' => '<i class="main-icon fa fa-sticky-note"></i> <span>' . controllers::t( 'menu', 'follow status of document' ) . '</span>', 'url' => ['approvalformsf/index'],
                    'visible' => $userType == AuthHelper::TYPE_ADMIN],
                ['label' => '<i class="main-icon fa fa-sticky-note"></i> <span>' . controllers::t( 'menu', 'follow status of document' ) . '</span>', 'url' => ['approvalformaj/index'],
                    'visible' => $userType == AuthHelper::TYPE_TEACHER],
                ['label' => '<i class="fa fa-menu-arrow pull-right"></i><i class="main-icon fa fa-sticky-note"></i> <span>' . controllers::t( 'menu', 'follow status of document' ) . '</span>',
                    'template' => '<a href="#">{label}</a>',
