            ...
            [
                ...
                'buttons'=>[
                    ...
                    'loan' => function ($url, $model,$key) {
                            return Html::a('<i class="	fa fa-plus"></i> '.\app\modules\eoffice_eolmv2\controllers::t( 'menu','Details for accommodation'), '@web/eoffice_eolmv2/receipthotel/index?id='.$model->eolm_app_id, ['class'=>'btn btn-block btn-social btn-success'],[
                                'title' => Yii::t('app', 'ทำรายละเอียดค่าที่พัก')
                            ]);
