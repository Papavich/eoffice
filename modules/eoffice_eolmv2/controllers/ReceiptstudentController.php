...
use app\modules\eoffice_eolmv2\models\EolmReceiptStudentajSearch;
use app\modules\eoffice_eolmv2\models\model_main\EofficeMainViewStudentFull;
use app\modules\eoffice_eolmv2\models\Person;
use Yii;
use app\modules\eoffice_eolmv2\models\EolmReceiptStudent;
use app\modules\eoffice_eolmv2\models\EolmReceiptStudentSearch;
...
class ReceiptstudentController extends Controller
{
    ...
    public function actionExcel($eolm_app_id,$person_id) {
        ...
        $sql1 = 'SELECT * FROM eoffice_eolmv2.eolm_receipt_student where eolm_app_id = '.$eolm_app_id.' and person_id = '.$person_id;
        $model1 = EolmReceiptStudent::findBySql($sql1)->one();

        $sql2 = 'SELECT * FROM eoffice_eolmv2.eolm_receipt_student_detail where eolm_app_id = '.$eolm_app_id.' and person_id = '.$person_id;
