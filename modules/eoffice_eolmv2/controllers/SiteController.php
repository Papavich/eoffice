...
class SiteController extends Controller
{
    ...
    public function actionTestmenuparent()
    {
        ...
        foreach (MenuHelper::getAssignedMenu(\Yii::$app->user->id) as $key => $a) { //เอา key ของ arrayมาเก็บไว้
            if ($a['label'] === "eoffice_eolmv2") { //if key index of lable === module5
    ...
    {
        echo \Yii::$app->authManager->getPermitReturn("/eoffice_eolmv2/menu/menu1","eoffice_eolmv2");
    }
