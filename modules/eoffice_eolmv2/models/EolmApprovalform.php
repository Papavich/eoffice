 ...
 * @property string $eolm_app_return_date
...
//    public $person_ids2 = []; /* add student  */
   /* public $vehicles;*/
    ...
    {
        return [
            [['eolm_app_date', 'eolm_app_event_date', 'eolm_app_deprture_date', 'eolm_app_return_date', 'crtime', 'udtime',
            ...
            //[['eolm_app_borrow_money'], 'number'],add project_sub_child_id to line 91
            [['eolm_budget_year', 'eolm_type_id', 'eolm_status_id', 'eolm_budp_id', 'eolm_budt_id', 'eolm_exp_id', 'pro_id','pro_child_id', 'crby', 'udby'], 'integer'],
            [['eolm_type_id', 'eolm_status_id','provinces','person_ids1','eolm_app_subject','eolm_app_date','eolm_app_event_date','eolm_app_deprture_date','eolm_app_return_date'], 'required'],
            ...
            [['pro_child_id'], 'exist', 'skipOnError' => true, 'targetClass' => ProjectSubChild::className(), 'targetAttribute' => ['pro_child_id' => 'pro_child_id']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'eolm_app_return_date' => controllers::t('label_appform','Day of return'),
            ...
            'pro_child_id' =>controllers::t('label_appform','Project'),
            'crby' => 'Crby',
            'crtime' => 'Crtime',
            'udby' => 'Udby',
            'udtime' => 'Udtime',
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getProChild()
    {
        return $this->hasOne(ProjectSubChild::className(), ['pro_child_id' => 'pro_child_id']);
    }
