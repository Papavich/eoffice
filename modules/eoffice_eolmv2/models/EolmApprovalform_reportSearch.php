 ...
 */
class EolmApprovalform_reportSearch extends EolmApprovalform
{   public $person1;
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['eolm_app_date', 'eolm_app_subject', 'eolm_app_number', 'eolm_app_deprture_date', 'eolm_app_return_date', 'eolm_budget_year', 'eolm_link', 'crtime', 'udtime'], 'safe'],
    ...
    {
        $n= $this->hasOne(Person::className(), ['person_id' => 'person_id'])->viaTable('eolm_approvalform_has_personal', ['eolm_app_id' => 'eolm_app_id'], function ($query) {
    ...
    {
        $query = EolmApprovalform::find()->joinWith('person1')/*-->joinWith('eolmApprovalformHasProvinces')*/->where(['eolm_status_id' => 3]);
        ...
        $query//->andFilterWhere(['between', 'eolm_app_date', $this->start_date, $this->end_date])
            ->andFilterWhere([
           ...
           // 'eolm_app_date' => $this->eolm_app_date,
            ...
            'eolm_app_return_date' => $this->eolm_app_return_date,
            ...
            //'eolm_approvalform_has_province'.'PROVINCE_ID' => $this->provinces,
        ]);
        ...
        $query->andFilterWhere(['like', 'eolm_app_subject', $this->eolm_app_subject])
           ...
           // ->andFilterWhere(['like', 'person_id', $this->person1]);
