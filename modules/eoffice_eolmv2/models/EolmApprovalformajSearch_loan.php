 ...
 */
class EolmApprovalformajSearch_loan extends EolmApprovalform
{    public $person1;
    /**
     * @inheritdoc
     */
    ...
    {
        $query = EolmApprovalform::find()->joinWith('person1')->leftJoin('eoffice_central.view_pis_user', 'eoffice_central.view_pis_user.person_id = eolm_approvalform_has_personal.person_id')->where(['eolm_status_id' => 1,'eoffice_central.view_pis_user.id'=>Yii::$app->user->identity->id]);
