...
use app\modules\eoffice_eolmv2\models\EolmReceiptHotel;

/**
 * EolmReceiptHotelSearch represents the model behind the search form of `app\modules\eoffice_eolmv2\models\EolmReceiptHotel`.
 */
class EolmReceiptHotelajSearch extends EolmReceiptHotel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = EolmReceiptHotel::find()->where(['crby' => Yii::$app->user->identity->getId()]);
