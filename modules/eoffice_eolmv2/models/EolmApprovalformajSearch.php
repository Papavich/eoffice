 ...
 */
class EolmApprovalformajSearch extends EolmApprovalform
{   public $person1;
    /**
     * @inheritdoc
     */
    ...
    {
        $q=EofficeMainViewPisUser::find()->where(['id'=>Yii::$app->user->identity->getId()])->one();

        $query = EolmApprovalform::find()->joinWith('person1')->where(['eolm_approvalform_has_personal.person_id' => $q->person_id]);
