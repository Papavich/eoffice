...
/**
 * LoancontractSearch represents the model behind the search form about `app\modules\eoffice_eolmv2\models\EolmLoancontract`.
 */
class LoancontractSearch extends EolmLoancontract
{
    /**
     * @inheritdoc
     */
