 ...
 */
class EolmApprovalform_approvSearch extends EolmApprovalform
{   public $person1;
    /**
     * @inheritdoc
     */
    ...
    {
        $query = EolmApprovalform::find()->joinWith('person1')->where(['eolm_status_id' => 2])->orWhere(['eolm_status_id' => 3])->orWhere(['eolm_status_id' => 4]);

        // add conditions that should always apply here

        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort'=> ['defaultOrder' => ['eolm_status_id'=>SORT_ASC]] //เรียงลำดับตามสถานะ DESCมากไปน้อย
        ]);
