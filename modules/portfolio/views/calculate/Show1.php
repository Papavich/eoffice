...
//                            }
                        ...
                        <td>
                            ...
                            foreach ($project->projectMembers as $projectMember) {
                                ...
                                if ($projectMember->project_role_id == 1) {
                                    echo \app\modules\portfolio\models\Person::findOne($projectMember->member_id)->person_name;
                                }
                        ...
                        <td>
                            ...
                            foreach ($project->projectMembers as $projectMember) {
                                ...
                                if ($projectMember->project_role_id !== 1) {
                                    if ($projectMember->projectRole !== null) echo  "(",$projectMember->projectRole->project_role_name,")";
                                    if ($projectMember->projectRole == null) echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp';

                                    if ($projectMember->member_id !== null) {
                                        echo \app\modules\portfolio\models\Person::findOne($projectMember->member_id)->person_name;
                                ...
                                if ($projectMember->member_name !== null) echo $projectMember->member_name;
