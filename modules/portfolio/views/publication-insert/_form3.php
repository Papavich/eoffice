    ...
    <fieldset>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-envelope"></i> เพิ่มข้อมูล (บทความทางวิชาการ )
            </div>
            <div class="row">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4   ">
                                ...
                                <?= $form->field($modelPublication, 'pub_name_thai')->textInput()->label("บทความ(ภาษาไทย)") ?>
                            ...
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'pub_name_eng')->textInput()->label("บทความ(ภาษาอังกฤษ)") ?>
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'book_name_thai')->textInput()->label("ชื่อหนังสือ(ภาษาไทย)") ?>
                            </div>


                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'book_name_eng')->textInput()->label("ชื่อหนังสือ(ภาษาอังกฤษ)") ?>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                        <?= $form->field($modelPublication, 'acticle_detail')->widget(CKEditor::className(), [
                            'options' => ['rows' => 2],
                            'preset' => 'standard',
                    ...
                    <div class="form-group">
                        <div class="col-md-2 col-sm-2">
                            <?= $form->field($modelPublication, 'number')->widget(\yii\widgets\MaskedInput::className(), [
                                'mask' => '999-999   หน้า'])->label("หน้าที่") ?>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <?= $form->field($modelPublication, 'issuance')->textInput()->label("ฉบับที่") ?>
                        </div>
                    ...
                    <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <?= $form->field($modelPublication, 'abstract')->widget(CKEditor::className(), [
                            'options' => ['rows' => 2],
                            'preset' => 'standard',
                        ])->label("บทคัดย่อ") ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-4 col-sm-4">
                            <?= $form->field($modelPublication, 'press')->textInput(['maxlength' => true])->label("สถานที่พิมพ์") ?>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <?= $form->field($modelPublication, 'publisher')->textInput(['maxlength' => true])->label("สำนักพิมพ์") ?>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <?= $form->field($modelPublication, 'editor')->textInput(['maxlength' => true])->label("บรรณาธิการ") ?>
                        </div>
                    </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <?= $form->field($modelPublication, 'impact_factor')->widget(\yii\widgets\MaskedInput::className(), [
                                'mask' => ' 99.999']); ?>
                        </div>
                        <div class="col-md-6 col-sm-6">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'countries_id')->textInput(['maxlength' => true])->dropDownList(ArrayHelper::map(app\modules\portfolio\models\Countries::find()->all(), 'id', 'name'), ['prompt' => 'เลือกประเทศ'])->label(" ประเทศ ") ?>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'states_id')->dropDownList(ArrayHelper::map(app\modules\portfolio\models\States::find()->all(), 'id', 'name'), ['prompt' => 'เลือกรัฐ'])->label(" รัฐ ") ?>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'cities_id')->dropDownList(ArrayHelper::map(app\modules\portfolio\models\Cities::find()->all(), 'id', 'name'), ['prompt' => 'เลือกเมือง'])->label(" เมือง") ?>
                            </div>
                        </div>
                    </div>
        ...
        <div class="form-group">
            <center><?= Html::submitButton($modelProjectMember->isNewRecord ? 'บันทึกข้อมูล' : 'Update', ['class' => 'btn btn-success'],['target'=>'_blank']) ?></center>
        </div>
...
if(decument.getElementById('pub_name_thai').value=""){
  alert('111111')
}
return false;
}
