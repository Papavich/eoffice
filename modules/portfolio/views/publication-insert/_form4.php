    ...
    <fieldset>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-envelope"></i> เพิ่มข้อมูล (การประชุมวิชาการ)
            </div>
            <div class="row">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'meeting_name_thai')->textInput()->label("ชื่องานไทย") ?>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'meeting_name_eng')->textInput()->label("ชื่องานอังกฤษ") ?>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'pub_name_thai')->textInput()->label("ชื่อผลงานภาษาไทย") ?>
                            </div>
                            <div class="col-md-4 col-sm-4">
                                <?= $form->field($modelPublication, 'pub_name_eng')->textInput()->label("ชื่อผลงานภาษาอังกฤษ") ?>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <?= $form->field($modelPublication, 'institution_ag_award_id')->dropDownList(ArrayHelper::map(app\modules\portfolio\models\Institution::find()->all(), 'ag_award_id', 'ag_award_name'), ['prompt' => 'หน่วยงาน / องค์กร / สถาบัน'])->label(" หน่วยงาน / องค์กร / สถาบันที่จัดงาน ") ?>
                        </div>
                        <div class="col-md-4 col-sm-4">


                            <?= $form->field($modelPublication, 'present_present_id')->dropDownList(ArrayHelper::map(app\modules\portfolio\models\Present::find()->all(), 'present_id', 'present_name'), ['prompt' => '-เลือก-'])->label(" ประเภทการประชุมวิชาการ ") ?>
                        </div>
                       </div>
                    </div>
        ...
        <div class="form-group">
            <center>
            <?= Html::submitButton($modelProjectMember->isNewRecord ? 'บันทึกข้อมูล' : 'Update', ['class' => 'btn btn-success']) ?>
            </center>
        </div>
