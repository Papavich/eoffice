    ...
    <div id="wrapper" class="clearfix">
        ...
        <header id="header">
            ...
            <span class="logo pull-left">
               <img src="<?= Yii::getAlias('@web') ?>/web_pfo/images/logo131.png" alt="admin panel" width="160" height="55" />
           </span>
        ...
        <div id="panel-1" class="panel panel-default">
            <div class="panel-heading">
                  <span class="title elipsis">
                    <strong>PORTFOLIO SYSTEM</strong> <!-- panel title -->
                  </span>
