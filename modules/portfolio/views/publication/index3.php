                    ...
                    <tr>ผู้ให้ข้อมูล : <?php
                        foreach ($row->publicationOrders as $projectMember)
                            ...
                            if ($projectMember->contributor_contributor_id == 1) {
                                if ($projectMember->projectMemberProMember->person_id != null) {

                                    //var_dump($person);

                                    //exit;
                                    $persons_main = Yii::$app->getDb()->createCommand('SELECT * FROM view_pis_user')->queryOne();


                                    echo $persons_main['person_fname_th'] . '' . $persons_main['person_lname_th'];
                                } else {
                ...
                <table >
                    ...
                    foreach ($row->publicationOrders as $projectMember) {
                            ...
                            if ($projectMember->authorLevelAuthLevel !== null) {
                                echo $projectMember->authorLevelAuthLevel->auth_level_name;
