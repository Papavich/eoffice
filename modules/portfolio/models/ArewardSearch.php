...
/**
 * ArewardSearch represents the model behind the search form of `app\modules\portfolio\models\Areward`.
 */
class ArewardSearch extends Areward
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['areward_id', 'level_level_id', 'institution_ag_award_id', 'cities_id', 'member_member_id', 'std_id', 'person_id'], 'integer'],
