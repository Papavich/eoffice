 ...
 */
class RepairDescriptionSearch extends RepairDescription
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['rep_desc_id', 'rep_image_id','staff_id'], 'integer'],
            [['rep_desc_detail', 'rep_desc_cost', 'rep_desc_comment', 'rep_desc_request_date', 'rep_location', 'asset_detail_id', 'asset_detail_name', 'staff_id'], 'safe'],
        ];
    }
