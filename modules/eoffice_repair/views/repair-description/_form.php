...
use app\modules\eoffice_repair\models\AssetDetail;
...
$this->title ='แก้ไขสถานะการแจ้งซ่อม';
...
<div id="panel-info" class="panel panel-danger cs-remargin" style="margin-top: 20px">
    <div class="panel-body">
        <div class="content-info">
            ...
            <!--            </h3>-->
            <h3>
                <i class="glyphicon glyphicon-edit"></i>แก้ไขสถานะ
...
<div class="form-group">
  ...
  <div class="form-group">
    <?= Html::submitButton($model->isNewRecord ? 'Create' : 'แก้ไข', ['class' => $model->isNewRecord ? 'btn btn-success ' : 'btn btn-primary pull-right']) ?>
  </div>
    <?php ActiveForm::end(); ?>
