<div class="table-responsive nomargin">
    <div class="preview-content">
        ...
        <div>ใบส่งของ เลขที่ : <span class="preview-heigtlight"><?= $model_bill_master['bill_master_id'] ?></span> เล่มที่ : <span
        ...
        foreach (array_combine($array_name,$model_detail) as $key => $value) {
            ...
            ?>
                            <tr>
                                ...
                                <td><?= number_format((float)$value['bill_detail_price_per_unit'], 2, '.', '') ?> <sapn class="pull-right">บาท</sapn></td>
                                <td><?= number_format((float)$value['bill_detail_price_per_unit']*$value['bill_detaill_amount'], 2, '.', '') ?> <sapn class="pull-right">บาท</sapn></td>
                            </tr>
            <?php
            $count++;
        }
