...
/* @var $type \app\modules\eoffice_materialsys\models\MatsysMaterialType */
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
							<span class="title elipsis">
								<strong><h4>ตารางหมวดหมู่วัสดุ</h4></strong> <!-- panel title -->
							</span>
        </div>
        <!-- Seacrch Page -->
                                ...
                                ['class' => 'yii\grid\ActionColumn', 'template' => '{custom_view}',
                                    ...
                                    'buttons' =>
                                        ['custom_view' => function ($url, $model) {
                                            /* @var $model \app\modules\eoffice_materialsys\models\MatsysMaterialType */
                                            // Html::a args: title, href, tag properties.
                                            return '<div class="btn-group btn-group-sm text-center" role="group">
                                    <a class="glyphicon glyphicon-pencil btn btn-3d btn-default btn-xs" data-toggle="modal" data-target="#myEdit' . $model->material_type_id . '"></a>
                                    <a class="glyphicon glyphicon-trash btn btn-3d btn-default btn-xs" data-toggle="modal" data-target="#myDel' . $model->material_type_id . '"></a>
                                        </div>';
                                        },
                                        ]
                                ],
            ...
            <div class="modal-content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default" align="center">
                        ...
                        <div class="panel-body">
                            <?php $form = ActiveForm::begin(['action' => ['deletetype'],]) ?>
                            <div class="modal-body" align="center">
                                <input type="hidden" name="type_id[]" value="<?= $type->material_type_id ?>">
            ...
            <div class="modal-content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <?php $form = ActiveForm::begin(['action' => ['updatetype'],]) ?>
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <label>รหัสหมวดหมู่</label>
                                        <input type="hidden" name="mat_id[]" value="<?= $type->material_type_id ?>">
                                ...
                                <div class="form-group">
                                    <div class="col-md-5 col-sm-5 col-xs-12">
                                        ...
                                        <input type="text" name="material_type_name[]"
                                               value="<?= $type->material_type_name ?>" class="form-control required">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
