...
$this->registerJsFile('@mat_assets/orderstatus/js/script-index.js', ['depends' => [yii\web\JqueryAsset::className()]]);
        ...
        <div class="modal-dialog modal-full" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div>
                        <label>รายละเอียดสถานที่รับ</label>
                        <textarea class="form-control" disabled><?= $order->order_cancel_description ?></textarea>
                    </div>
                </div>
