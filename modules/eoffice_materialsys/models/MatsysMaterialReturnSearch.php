 ...
 */
class MatsysMaterialReturnSearch extends MatsysMaterial
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        if(isset($params['search'])){
                $query = MatsysMaterial::find()
                    ->innerJoin('matsys_order_return','matsys_material.material_id = matsys_order_return.material_id')
                    ->where('order_return_date_accept')
                    ->andWhere(['like','matsys_order_return.material_id',$params['search']])
                    ->orWhere(['like','matsys_material.material_name',$params['search']]);
