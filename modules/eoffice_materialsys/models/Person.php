...
/**
 * This is the model class for table "eoffice_main.view_pis_person".
 *
 * @property int $id
...
class Person extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id', 'person_id', 'person_current_district', 'person_current_amphur', 'person_current_province', 'person_current_zipcode', 'person_home_district', 'person_home_amphur', 'person_home_province', 'person_home_zipcode', 'person_type', 'major_id', 'person_religion_id', 'person_nation_id'], 'integer'],
            [['type', 'email', 'username'], 'required'],
            ...
            [['type', 'person_card_id', 'person_mobile'], 'string', 'max' => 20],
    ...
    public static function getFullname($model){
        if (Yii::$app->language == "en") {
            return $model->PREFIXNAME." ".$model->person_name_eng." ".$model->person_surname_eng;
        } else {
            return $model->PREFIXNAME." ".$model->person_name." ".$model->person_surname;
        }
    }
}
