            ...
            <ul class='nav nav-list'>
                ...
                <?php } else {
                    ...
                    switch ($user['user_type_id']) {
                        ...
                        case 0: ?>
                            <li>
                                <a class='dashboard' href='<?= Yii::getAlias('@web/egs/todo/list') ?>'>
                                    <i class='main-icon fa fa-slack'></i>
                                    <span>รายการที่ต้องทำ</span>
                                </a>
                            </li>
                            <li>
                                <a class='dashboard' href='<?= Yii::getAlias('@web/egs/advisor/work-load') ?>'>
                                    <i class='main-icon fa fa-slack'></i>
                                    <span>ภาระงานอาจารย์</span>
                                </a>
                            </li>
                            <li>
                                <a class='dashboard' href='<?= Yii::getAlias('@web/egs/request/list') ?>'>
                                    <i class='main-icon fa fa-slack'></i>
                                    <span>ขอยื่นคำร้อง</span>
                                </a>
                            </li>
                            <li>
                                <a class='dashboard' href='<?= Yii::getAlias('@web/egs/request/all') ?>'>
                                    <i class='main-icon fa fa-slack'></i>
                        ...
                        case 3: ?>
                            ...
                            <li>
                                <a class='dashboard' href='<?= Yii::getAlias('@web/egs/calendar/list') ?>'>
                                    <i class='main-icon fa fa-slack'></i>
                            ...
                            <li>
                                <a class='dashboard' href='<?= Yii::getAlias('@web/egs/defense/all') ?>'>
                                    <i class='main-icon fa fa-slack'></i>
                                    <span>รายการสอบ</span>
                                </a>
                            </li>
