...
$this->title = 'เพิ่มผู้พิจารณา';
$this->params['breadcrumbs'][] = ['label' => 'แบบฟอร์มคำร้อง', 'url' => ['req-template/index']];
//$this->params['breadcrumbs'][] = ['label' => 'Template : ', 'url' => ['req-template/view','id' => $model->approveGroup->template_id]];
$this->params['breadcrumbs'][] = ['label' => 'กลุ่มผู้พิจารณา', 'url' => ['approve-group/view','id' => $group_id]];
$this->params['breadcrumbs'][] = 'เพิ่มผู้พิจารณา';
?>
