...
<section id="middle">
    ...
    <ul class="messages"><?php include("chatStudent_msg.php"); ?></ul> <!-- ดึงหน้า chat_msg.php มาแสดงในกล่องแชท chat_msg.php คือข้อความของ user -->
    ...
    (function () {
        ...
        $(function () {
            ...
            $('.send_message').click(function (e) {
                $.get('<?= Yii::$app->homeUrl ?>chat/chat_send?name=1', {msg: getMessageText()}, function () {});
...
//                $('.messages').load('<?//= Yii::$app->homeUrl ?>//chat/chat_msg');
                ...
                $.get('<?= Yii::$app->homeUrl ?>/chat/chat_msg?name=1', function (data) {
