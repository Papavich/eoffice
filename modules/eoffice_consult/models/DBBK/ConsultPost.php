...
class ConsultPost extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'consult_post_ark_detail' => 'รายละเอียดปัญหา',
            'consult_post_ark_date' => 'วันที่',
            'consult_user_id' => 'ผู้ถาม',
