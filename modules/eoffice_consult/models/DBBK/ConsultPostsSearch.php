...
use app\modules\eoffice_consult\models\ConsultPosts;

/**
 * ConsultPostsSearch represents the model behind the search form of `app\modules\eoffice_consult\models\ConsultPosts`.
 */
class ConsultPostsSearch extends ConsultPosts
{
    /**
     * @inheritdoc
     */
