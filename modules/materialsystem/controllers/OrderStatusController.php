...
use app\modules\materialsystem\models\OrderStatusSearch;
...
class OrderStatusController extends Controller
{
    ...
    {
        $query = MatsysOrder::find()->where(['person_id' => \app\modules\materialsystem\models\Person::findOne(Yii::$app->user->identity->getId())->id])->andWhere(['order_status' => '0']);
