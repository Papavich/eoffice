            ...
            [
                ...
                'buttons'=>[
                    'loan' => function ($url, $model,$key) {
                        return Html::a('<i class="	fa fa-plus"></i> '.\app\modules\eoffice_eolm\controllers::t( 'menu','Create a Receipt for Student'), '@web/eoffice_eolm/receiptstudent/index?id='.$model->eolm_app_id, ['class'=>'btn btn-block btn-social btn-success'],[
