...
$this->title = \app\modules\eoffice_eolm\controllers::t( 'menu','Create receipt for student');
...
if ($userType==AuthHelper::TYPE_ADMIN){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Search receipt for student'), 'url' => ['index', 'id' => $_GET["id"]]];
}elseif ($userType==AuthHelper::TYPE_TEACHER||$userType == AuthHelper::TYPE_APPROVERS){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Search receipt for student'), 'url' => ['index', 'id' => $_GET["id"]]];
}
