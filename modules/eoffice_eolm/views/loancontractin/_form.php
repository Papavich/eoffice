...
<div class="eolm-loancontract-form">
    ...
    $command2 = 'SELECT * FROM eolm_approvalform WHERE eolm_approvalform.eolm_app_id ='.$model->eolm_app_id;
    $appform = EolmApprovalform::findBySql($command2)->one();
    $date1 = new DateTime($appform['eolm_app_retuen_date']);
        ...
        <div class="panel panel-info ">
            <div class="panel-body">
                <div class="row">
                    ...
                    <?php if ($appform->eolm_status_id == 3 && $userType==\app\modules\eoffice_eolm\components\AuthHelper::TYPE_ADMIN ){
                        echo '
                        <div class="col-md-3 col-sm-3">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-6">
            ...
            <textarea rows="auto" class="form-control word-count" >ค่าใช้จ่ายในการเดินทางไปราชการระหว่างวันที่ < $appform->eolm_app_deprture_date;?> ถึงวันที่ < echo $appform->eolm_app_retuen_date;?> ณ จังหวัด < foreach ($province as $key){
