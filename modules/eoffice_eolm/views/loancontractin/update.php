...
$this->title = \app\modules\eoffice_eolm\controllers::t( 'menu','Update contract loan');
...
if ($userType==AuthHelper::TYPE_ADMIN){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Search approval form'), 'url' => ['approvalformsf/approvalsearch']];
}elseif ($userType==AuthHelper::TYPE_TEACHER||$userType == AuthHelper::TYPE_APPROVERS){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Search approval form'), 'url' => ['approvalformaj/approvalajsearch']];
}
$this->params['breadcrumbs'][] = \app\modules\eoffice_eolm\controllers::t( 'menu','Update contract loan');
?>
