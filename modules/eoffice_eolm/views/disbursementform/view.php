...
$this->title = \app\modules\eoffice_eolm\controllers::t( 'menu','Details for expenses');
...
if ($userType==\app\modules\eoffice_eolm\components\AuthHelper::TYPE_ADMIN){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Check document'), 'url' => ['approvalformsf/index']];
}elseif ($userType==\app\modules\eoffice_eolm\components\AuthHelper::TYPE_TEACHER){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Check document'), 'url' => ['approvalformaj/index']];
}
