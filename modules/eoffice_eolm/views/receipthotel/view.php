...
$this->title = \app\modules\eoffice_eolm\controllers::t( 'menu','Details for accommodation');
...
-->
    ...
    <div class="form-group text-center">
        ...
        if ($userType==\app\modules\eoffice_eolm\components\AuthHelper::TYPE_ADMIN){
            echo Html::a(\app\modules\eoffice_eolm\controllers::t( 'menu','Back'), ['index','id'=>$model->eolm_app_id], ['class' => 'btn btn-primary']);
