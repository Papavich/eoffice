...
$this->title = \app\modules\eoffice_eolm\controllers::t( 'menu','Update details for accommodation');
...
if ($userType==AuthHelper::TYPE_ADMIN){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Search details for accommodation'), 'url' => ['index', 'id' => $_GET["eolm_app_id"]]];
}elseif ($userType==AuthHelper::TYPE_TEACHER||$userType == AuthHelper::TYPE_APPROVERS){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Search details for accommodation'), 'url' => ['indexaj', 'id' => $_GET["eolm_app_id"]]];
}
