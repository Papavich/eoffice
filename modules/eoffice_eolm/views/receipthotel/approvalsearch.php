            ...
            [
                ...
                'buttons'=>[
                    ...
                    'loan' => function ($url, $model,$key) {
                            return Html::a('<i class="	fa fa-plus"></i> '.\app\modules\eoffice_eolm\controllers::t( 'menu','Details for accommodation'), '@web/eoffice_eolm/receipthotel/index?id='.$model->eolm_app_id, ['class'=>'btn btn-block btn-social btn-success'],[
