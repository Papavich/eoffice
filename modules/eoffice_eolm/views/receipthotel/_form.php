    ...
    <div class="panel panel-info">
        <div class="panel-body">
            <div class="row">
                <!--<div class="col-md-3 col-md-offset-3 col-sm-3 col-sm-offset-3">
                    <?/*= $form->field($model, 'eolm_app_id')->widget(Select2::classname(), [
                        //'data' => ArrayHelper::map(\app\modules\eoffice_eolm\models\EolmApprovalform::find()->joinWith('person1')->leftJoin('eoffice_central.view_pis_user', 'eoffice_central.view_pis_user.person_id = eolm_approvalform_has_personal.person_id')->where(['eoffice_central.view_pis_user.id'=>Yii::$app->user->identity->id])->asArray()->all(),'eolm_app_id','eolm_app_subject'),
                        'data' => ArrayHelper::map(\app\modules\eoffice_eolm\models\EolmApprovalform::find()->asArray()->all(),'eolm_app_id','eolm_app_subject'),
                ...
                <div class="col-md-4 col-sm-4">
                    ...
                    echo $form->field($model, 'eolm_hotel_id')->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(\app\modules\eoffice_eolm\models\EolmHotel::find()->asArray()->all(),'eolm_hotel_id','eolm_hotel_name'),
                        'theme' => Select2::THEME_BOOTSTRAP,
                        'language' => 'th',
            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-2">
                    <?= $form->field($model, 'eolm_rec_hotel_nights_amount')->textInput(['maxlength' => true,'id'=>'calDate','readOnly'=>true])->label(controllers::t( 'label','Number (night)') ) ?>
