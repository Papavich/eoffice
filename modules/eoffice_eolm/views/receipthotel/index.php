...
$this->title = \app\modules\eoffice_eolm\controllers::t( 'menu','Search details for accommodation');
use app\modules\eoffice_eolm\components\AuthHelper;
$userType = AuthHelper::getUserType();
if ($userType==AuthHelper::TYPE_ADMIN){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Search approval form'), 'url' => ['approvalsearch', 'id' => $_GET["id"]]];
}elseif ($userType==AuthHelper::TYPE_TEACHER||$userType == AuthHelper::TYPE_APPROVERS){
    $this->params['breadcrumbs'][] = ['label' => \app\modules\eoffice_eolm\controllers::t( 'menu','Search approval form'), 'url' => ['approvalajsearch', 'id' => $_GET["id"]]];
}
...
<div class="eolm-receipt-hotel-index">
    ...
    <p>
        <?= Html::a('<i class="	fa fa-plus"></i>'.\app\modules\eoffice_eolm\controllers::t( 'menu','Create Details for accommodation'), '@web/eoffice_eolm/receipthotel/create?id='.$_GET['id'], ['class'=>'btn btn-social btn-success'],[
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['attribute' => 'eolm_app_id',
                ...
                'label' => \app\modules\eoffice_eolm\controllers::t( 'label_appform','Subject'),
            ],
            ['attribute' => 'eolm_hotel_id',
                'value'=>'eolmHotel.eolm_hotel_name',
                'label' => \app\modules\eoffice_eolm\controllers::t( 'label','Stay at'),
            ],['attribute' => 'eolm_rec_hotel_stay_date',
                'label' => \app\modules\eoffice_eolm\controllers::t( 'label','Check in date'),
            ],['attribute' => 'eolm_rec_hotel_checkout_date',
                'label' => \app\modules\eoffice_eolm\controllers::t( 'label','Check out date'),
            ],
