...
use app\modules\eoffice_eolm\models\EolmApprovalform_reportSearch;
...
use app\modules\eoffice_eolm\models\EolmApprovalformsfSearch_loan;
...
class ApprovalformsfController extends Controller
{
    ...
    public function actionWord($id) /*function ปริ้น word */
    {
        ...
        $eolm_app_retuen_date=Yii::$app->thaiFormatter->asDate($model->eolm_app_retuen_date, 'long')." ";
        ...
        $sql2 = 'SELECT * FROM eoffice_olm.eolm_approvalform_has_personal  
                    LEFT JOIN eoffice_central.view_pis_person ON eoffice_olm.eolm_approvalform_has_personal.person_id = eoffice_central.view_pis_person.person_id 
                    WHERE eoffice_olm.eolm_approvalform_has_personal.eolm_app_id='.$model->eolm_app_id.'
                    AND eoffice_olm.eolm_approvalform_has_personal.eolm_app_has_person_type_id=2';
        ...
        $sql3 = 'SELECT * FROM eoffice_olm.eolm_signer  
                    LEFT JOIN eoffice_central.view_pis_person ON eoffice_olm.eolm_signer.person_id = eoffice_central.view_pis_person.person_id 
                    WHERE eoffice_olm.eolm_signer.eolm_signer_type_id =2';
