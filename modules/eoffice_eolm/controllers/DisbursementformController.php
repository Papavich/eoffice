...
use app\modules\eoffice_eolm\models\EolmDisbursementSearch;
use app\modules\eoffice_eolm\models\EolmApprovalformsfSearch;

use app\modules\eoffice_eolm\models\Uploads;
    ...
    private function getInitialPreview($ref) {
        ...
        foreach ($datas as $key => $value) {
            ...
            array_push($initialPreviewConfig, [
                ...
                'width'  => '120px',
                'url'    => Url::to(['/eoffice_eolm/disbursementform/deletefile-ajax']),
                'key'    => $value->upload_id
            ]);
        }
...
/*|*********************************************************************************|*/
    ...
    public function actionExcel2($id,$person_id) {
        ...
        $sql2 = 'SELECT * FROM eoffice_olm.eolm_disbursementform_details_item where eolm_app_id = '.$id.' and eolm_dis_detail_bill = 2 and person_id = '.$person_id.' and eolm_dis_type=1 or eolm_dis_type=2';
