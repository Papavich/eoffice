...
/**
 * AssetUserSearch represents the model behind the search form of `app\modules\eoffice_asset\models\AssetDetail`.
 */
class AssetUserSearch extends AssetDetail
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['asset_detail_id', 'asset_asset_id', 'asset_dept_type', 'asset_detail_amount', 'asset_detail_age', 'asset_detail_price', 'asset_detail_price_wreck', 'asset_detail_insurance', 'asset_detail_room'], 'integer'],
            [['asset_univ_code_start', 'asset_univ_type', 'asset_dept_code_start', 'asset_detail_name', 'asset_detail_brand', 'asset_detail_building', 'asset_detail_image', 'asset_detail_status'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'asset_detail_status' => $this->asset_detail_status,
        ]);
        ...
        $query->andFilterWhere(['like', 'asset_univ_code_start', $this->asset_univ_code_start])
            ...
            ->andFilterWhere(['like', 'asset_detail_building', $this->asset_detail_building])
            ->andFilterWhere(['like', 'asset_detail_image', $this->asset_detail_image]);
