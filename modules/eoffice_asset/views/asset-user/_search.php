...
/* @var $model app\modules\eoffice_asset\models\AssetUserSearch */
...
<div class="asset-detail-search">
    ...
    <?= $form->field($model, 'asset_asset_id') ?>
    ...
    <?php // echo $form->field($model, 'asset_dept_type') ?>
    ...
    <?php // echo $form->field($model, 'asset_detail_image') ?>

    <?php // echo $form->field($model, 'asset_detail_status') ?>
