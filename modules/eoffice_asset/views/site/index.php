<?php
use app\modules\eoffice_asset\controllers;
...
<div id="content" class="dashboard padding-20">
    <div id="panel-1" class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="flot-sales" class="fullwidth height-250">หน้ากลาง</div>
            <?php
            if (!Yii::$app->user->isGuest) {
                if (Yii::$app->user->identity->username == 'theerayut') {
                    print('Account(' . Yii::$app->user->identity->username . ')');
                    ?>
                    <div style="font-size: 60px">Welcome Tjung69</div>
                    <?php
                } else {
                    print('Account(' . Yii::$app->user->identity->username . ')');
                }
