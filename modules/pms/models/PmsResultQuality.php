...
/**
 * This is the model class for table "pms_result_quality".
 *
 * @property int $quality_id
 * @property string $quality_detail
 * @property int $pms_compact_has_prosub_id
 *
 * @property PmsCompactHasProsub $pmsCompactHasProsub
 */
class PmsResultQuality extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
