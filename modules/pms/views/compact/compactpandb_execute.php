                    ...
                    if($comhasexecute!= null) {
                        ...
                        <div class="panel-body">
                            <?php $form = ActiveForm::begin(['id' => 'dynamic-form','options' => [
                                'class' => 'execute-pandb'
                            ] , 'action' => '../compact/saveexecutepandb']); ?>
                            ...
                            <fieldset>
                                ...
                                <label><b>ข. ขออนุมัติใช้เงินงบประมาณ</b></label><br>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <a class="btn btn-3d btn-default pull-left"
                                           href="../compact/previouscompactpandb?compact=<?= $compact ?>&id=<?= $id ?>">ย้อนกลับ</a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <button type="button" id="submit_executepandb" class="btn btn-3d btn-success pull-right">บันทึก</button>
                                    </div>
                                </div>
                            </fieldset>
                            <?php ActiveForm::end(); ?>
