    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <p>สถานะขออนุมัติจัดโครงการ :
                ...
                ?>
                <?php
                if($modelcomhasprosub->status_result =="รอฝ่ายพัฒนานักศึกษาตรวจสอบ"){
                    echo "<a class=\"btn btn-sm btn-3d btn-info\" href=\"../permissionsummary/permis-staff?id=".$modelprosub->prosub_code."&compact=".$id_compact."\"><i class=\"fa fa-check\"> อนุมัติ</i></a> ";
            ...
            <div class="text-right">
                ...
                <a class="btn btn-3d btn-blue" href="../addprosubresult/result-select"><i
...
<div class="modal fade" id="notconfirmed" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="../commentsummary/comment-staff">
