    ...
    <div id="page-content" class="panel panel-default">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <?php
                if($prosub->prosub_status_offer =="รอฝ่ายพัฒนานักศึกษาตรวจสอบ"){
                    echo "<a class=\"btn btn-sm btn-3d btn-info\" href=\"../permission/permis-pronone-systemoffer-staff?id=".$prosub->prosub_code."\"><i class=\"fa fa-check\"> ตรวจสอบ</i></a> ";
                ...
                <div class="text-right">
                    <a class="btn btn-3d btn-blue" href="../tablepro/permis-staff"><i class="glyphicon glyphicon-arrow-left"></i>ย้อนกลับ</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="notconfirmed" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="../comment/commentoffer-staff">
