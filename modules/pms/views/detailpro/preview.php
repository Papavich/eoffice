...
<style>
    ...
    <div id="content" class="padding-20">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                 <p><a href="#" data-toggle="modal" class="get_status" data="<?=$prosub->prosub_code?>" data-target="#showstatus">สถานะโครงการ</a> :
                     <?php
                        echo $prosub->prosub_status_offer;
                     ?>
                     <?php

                     if($prosub->prosub_status_offer =="ยังไม่ดำเนินการ"){
                ...
                <div class="text-right">
                    <?php
                        if($prosub->prosub_status_offer == "ยังไม่ดำเนินการ" || $prosub->prosub_status_offer == "รอปรับแก้ไขโครงการ"){
                            echo "<a class=\"btn btn-warning\" href=\"../addprosub/prosub-edit?id=".$prosub->prosub_code."\"><i class=\"fa fa-pencil-square-o\"></i> แก้ไข</a>";
                        }else{
