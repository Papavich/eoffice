...
<div id="content" class="padding-20">
    ...
    <div class="panel panel-default">
            <div class="panel-body">
                ...
                if($prosub->prosub_status_offer =="รอหัวหน้าภาคอนุมัติ"){
                    echo "<a class=\"btn btn-sm btn-3d btn-info\" href=\"../permission/permis-pronone-systemoffer-manager?id=".$prosub->prosub_code."\"><i class=\"fa fa-check\"> อนุมัติ</i></a>";
...
<div class="modal fade" id="notconfirmed" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="../comment/commentoffer-manager">
