...
<!--                <span style="background-color: #d9534f" class="badge pull-right">0</span><span class="label label-success" style="width: 100px;display: inline-block">แจ้งเตือน</span>-->
                ...
                <ul class="nav nav-list">
                    <li class="el_primary menu-open" id="el_1">
                        <a href="../tablepro/permis-manager"><span>โครงการลงปีงบประมาณ</span><span style="background-color: #f4b04f" class="badge pull-right"><?=sizeof($prosub_offer)?></span>
                        </a>
                    </li>
                    <li class="el_primary menu-open" id="el_1">
                        <a href="../tablepro/permis-manager"> <span>จัดโครงการ</span><span style="background-color: #f4b04f" class="badge pull-right"><?=sizeof($prosub_place)?></span>
                        </a>
                    </li>
                    <li class="el_primary menu-open" id="el_1">
                        <a href="../tablepro/permis-manager"> <span>ขอใช้งบประมาณ</span><span style="background-color: #f4b04f" class="badge pull-right"><?=sizeof($prosub_budget)?></span>
                        </a>
                    </li>
                    <li class="el_primary menu-open" id="el_1">
                        <a href="../tablepro/permis-manager"> <span>จัดโครงการพร้อมใช้งบประมาณ</span><span style="background-color: #f4b04f" class="badge pull-right"><?=sizeof($prosub_pandb)?></span>
                        </a>
                    </li>
                </ul>
