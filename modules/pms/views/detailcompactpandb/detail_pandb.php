    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <p><a href="#" data-toggle="modal" class="get_status_pandb" data="<?=$modelprosub->prosub_code."_".$compact?>" data-target="#showstatus">
                ...
                ?>
                <?php
                if($modelcompacthasprosub->status_pandf =="ยังไม่ดำเนินการ" ){
                    echo "<a class=\"btn-3d btn-sm btn btn-info\" href=\"../permissionpandb/permis?id=".$modelprosub->prosub_code."&compact=".$compact."\"><i class=\"fa fa-check\"></i> ขออนุมัติ</a>";
                }
            ...
            <div class="text-right">
                <?php
                if($modelcompacthasprosub->status_pandf == "ยังไม่ดำเนินการ" || $modelcompacthasprosub->status_pandf == "รอปรับแก้ไขโครงการ"){
                    echo "<a class=\"btn btn-warning\" href=\"../compact/editcompactpandb?id=".$modelprosub->prosub_code."&compact=".$compact."\"><i class=\"fa fa-pencil-square-o\"></i> แก้ไข</a>";
                }else{
