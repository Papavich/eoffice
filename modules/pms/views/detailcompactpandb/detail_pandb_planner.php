    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <p><a href="#" data-toggle="modal" class="get_status_pandb" data="<?=$modelprosub->prosub_code."_".$compact?>" data-target="#showstatus">
                ...
                ?>
                <?php
                if($modelcompacthasprosub->status_pandf =="รองานนโยบายและแผนอนุมัติ" ){
                    echo "<a class=\"btn btn-sm btn-3d btn-info\" href=\"../permissionpandb/permis-planner?id=".$modelprosub->prosub_code."&compact=".$compact."\"><i class=\"fa fa-check\"> อนุมัติ</i></a> ";
...
<div class="modal fade" id="notconfirmed" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="../commentpandb/comment-planner">
