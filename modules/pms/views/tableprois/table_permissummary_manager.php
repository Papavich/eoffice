                    ...
                    <div class="col-md-12" style="margin-top: 20px">
                        <table id="table_compact_summary" class="table table-striped table-bordered">
                            ...
                            foreach ($prosub as $key => $rows){
                                if($rows['status_result']=="รอหัวหน้าภาคอนุมัติ") {
                                    $i = $key + 1;
                                    ?>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <a><i class=""></i></a>
                                            <?php
                                            echo "<a href=\"../detailprosubresult/detail-manager?id=".$rows['prosub_code']."&id_compact=".$rows['id']."\"><i class=\"glyphicon glyphicon-eye-open\"></i></a> ";
                                            echo " | <a href=\"../permissionsummary/permis-manager?id=".$rows['prosub_code']."&compact=".$rows['id']."\"><i class=\"glyphicon glyphicon-check\"></i></a> ";
                                            ?>
