                            ...
                            <table id="table1" class="table table-striped table-hover table-bordered">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a href="../detailinpro/detailpro?id=<?=$rows['prosub_code']?>"><?=$rows['prosub_name']?></a>
                                        </td>
                                        <td></td>
                                        <td>
                                            <?php
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-success" href="../compact/addcompactplan?id=<?= $rows['prosub_code'];?>"><i class="fa fa-plus"></i> เพิ่ม 104</a>
                                        </td>
                                    </tr>
                                    <?php
                                    $count++;
