        ...
        <div class="panel panel-default">
            <div class="panel-body">
                 <p>สถานะขออนุมัติจัดโครงการ :
                     ...
                     if($prosub->prosub_status_place =="ยังไม่ขออนุมัติ"){
                         echo "<a class=\"btn btn-3d btn-sm btn btn-info\" href=\"../permissionplace/permis-pro-system?id=".$prosub->prosub_code."\"><i class=\"fa fa-check\"></i> ขออนุมัติ</a>";
                     }
                     else if($prosub->prosub_status_place =="อนุมัติจัดโครงการสำเร็จ"){
                         echo "<a class=\"btn btn-3d btn-sm btn btn-info\" disabled='disabled'  id=\"submit\"><i class=\"fa fa-check\"></i> ขออนุมัติ</a>";
                     }
                     else{
                         echo "<a class=\"btn btn-3d btn-sm btn btn-info\" disabled='disabled'  id=\"submit\"><i class=\"fa fa-hourglass-2\"></i> ขออนุมัติ</a>";
                     }
                     ?>
                </p>
                <p>สถานะขอใช้งบประมาณ :
                    ...
                    if($prosub->prosub_status_finance =="ยังไม่ขออนุมัติ"){
                        echo "<a class=\"btn btn-3d btn-sm btn btn-info\" href=\"../permissionfinance/permis-pro-system?id=".$prosub->prosub_code."\"><i class=\"fa fa-check\"></i> ขออนุมัติ</a>";
                    }
                ...
                <div class="text-right">
                    <a class="btn btn-warning" href="../editpro/editprois?id=<?= $prosub->prosub_code;?>"><i class="fa fa-pencil-square-o"></i> แก้ไข</a>
                    ...
                    <a class="btn btn-blue" href="../tableprois/table-in-system"><i class="glyphicon glyphicon-arrow-left"></i>ย้อนกลับ</a>
                </div>
            </div>
        </div>
