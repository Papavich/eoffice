        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <p>สถานะขออนุมัติจัดโครงการ :
                    <?php
                    echo $prosub->prosub_status_place;
                    ?>
                    <?php

                    if($prosub->prosub_status_place =="รอฝ่ายพัฒนานักศึกษาอนุมัติ"){
                        echo "<a class=\"btn btn-3d btn-info\" href=\"../permissionplace/permis-pro-system-staff?id=".$prosub->prosub_code."\"><i class=\"fa fa-check\"> อนุมัติ</i></a> ";
                        echo " <a class=\"btn btn-3d btn-danger\" data-toggle=\"modal\" data-target=\"#notconfirmedplace\"><i class=\"fa fa-close\"></i> ไม่ผ่านการอนุมัติ</a>";
                    }
                    else if($prosub->prosub_status_place =="อนุมัติจัดโครงการสำเร็จ"){
                        echo "<a class=\"btn btn-3d btn-info\" disabled='disabled'  id=\"submit\"><i class=\"fa fa-check\"> อนุมัติ</i></a>";
                    }
                    else{
                        echo "<a class=\"btn btn-3d btn-info\" disabled='disabled'  id=\"submit\"><i class=\"fa fa-hourglass-2\"> อนุมัติ</i></a>";
                    }
                    ?>
                </p>
                <p>สถานะขอใช้งบประมาณ :
                    <?php
                    echo $prosub->prosub_status_finance;
                    ?>
                    <?php

                    if($prosub->prosub_status_finance =="รอฝ่ายพัฒนานักศึกษาอนุมัติ"){
                        echo "<a class=\"btn btn-3d btn-info\" href=\"../permissionfinance/permis-pro-system-staff?id=".$prosub->prosub_code."\"><i class=\"fa fa-check\"> อนุมัติ</i></a> ";
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-3d btn-success word-export" href="javascript:void(0)" target="_blank"><i
                                class="glyphicon glyphicon-circle-arrow-down"></i> ดาวโหลดเอกสาร</a>


                    <a class="btn btn-3d btn-blue" href="../tableprois/table-permis-staff-in-system"><i class="glyphicon glyphicon-arrow-left"></i>ย้อนกลับ</a>
                </div>
            </div>
        </div>

    </div>
<div class="modal fade" id="notconfirmedplace" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="../commentplace/comment-staff">
