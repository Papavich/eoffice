        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <p>สถานะขออนุมัติจัดโครงการ :
                    ...
                    if($prosub->prosub_status_place =="รอหัวหน้าภาคอนุมัติ"){
                        echo "<a class=\"btn btn-3d btn btn-info\" href=\"../permissionplace/permis-pro-system-manager?id=".$prosub->prosub_code."\"><i class=\"fa fa-check\"> อนุมัติ</i></a>";
                ...
                <p>สถานะขอใช้งบประมาณ :
                    ...
                    if($prosub->prosub_status_finance =="รอหัวหน้าภาคอนุมัติ"){
                        echo "<a class=\"btn btn-3d btn btn-info\" href=\"../permissionfinance/permis-pro-system-manager?id=".$prosub->prosub_code."\"><i class=\"fa fa-check\"> อนุมัติ</i></a>";
                ...
                <div class="text-right">
                    ...
                    <a class="btn btn-blue" href="../tableprois/table-permis-manager-in-system"><i class="glyphicon glyphicon-arrow-left"></i>ย้อนกลับ</a>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="notconfirmedplace" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="post" action="../commentplace/comment-manager">
