    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <p>สถานะขออนุมัติจัดโครงการ :
                ...
                ?>
                <?php
                if($modelcompacthasprosub->status_finance =="รอการเงินอนุมัติ" ){
                    echo "<a class=\"btn btn-sm btn-3d btn-info\" href=\"../permissionfinance/permis-finance?id=".$modelprosub->prosub_code."&compact=".$compact."\"><i class=\"fa fa-check\"> อนุมัติ</i></a> ";
            ...
            <div class="text-right">
                ...
                <a class="btn btn-blue" href="../tableprois/table-permisbudget-finance"><i class="glyphicon glyphicon-arrow-left"></i>ย้อนกลับ</a>
            </div>
        </div>
    </div>
</div>
