        ...
        <div class="panel-body">
            <p>สถานะขออนุมัติจัดโครงการ :
                ...
                if($modelcompacthasprosub->status_finance =="รอฝ่ายพัฒนานักศึกษาตรวจสอบ"){
                    echo "<a class=\"btn btn-sm btn-3d btn-info\" href=\"../permissionfinance/permis-staff?id=".$modelprosub->prosub_code."&compact=".$compact."\"><i class=\"fa fa-check\"> อนุมัติ</i></a> ";
            ...
            <div class="text-right">
                ...
                <a class="btn btn-blue" href="../tableprois/table-permisbudget-staff"><i class="glyphicon glyphicon-arrow-left"></i>ย้อนกลับ</a>
            </div>
        </div>
    </div>
</div>
