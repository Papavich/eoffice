                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="col-md-12" style="margin-top: 20px">
                            <table id="table_permisoffer_manager_in_system" class="table table-striped table-bordered">
                                <thead>
                                <tr>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../detailpro/detailpromanager?id=<?=$rows['prosub_code']?>"><i class="glyphicon glyphicon-eye-open"></i></a> | <a  href="../permission/permis-pronone-systemoffer-manager?id=<?=$rows['prosub_code']?>"><i class="glyphicon glyphicon-check"></i></a>
                                        </td>
