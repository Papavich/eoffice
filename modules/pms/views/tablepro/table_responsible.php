    ...
    <div class="page-profile">
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                        ...
                        <div class="col-md-12" style="margin-top: 20px">
                            <table id="table_wait_in_system" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th width="15%">สถานะของโครงการ</th>
                                ...
                                foreach ($prosub as $rows){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" data-toggle="modal" class="get_status" data="<?=$rows['prosub_code']?>" data-target="#showstatus">
                                                <?php
                                        ...
                                        <td>
                                            <span>
                                                <?php
                                                echo $rows['prosub_comment_offer'];
                                                ?>
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            if($rows->prosub_status_offer == "ยังไม่ดำเนินการ" || $rows->prosub_status_offer == "รอปรับแก้ไขโครงการ"){
                                                ...
                                                echo "<a href=\"../detailpro/detailproall?id=".$rows['prosub_code']."\"><i class=\"glyphicon glyphicon-eye-open\"></i></a>";
                                            }
                                            ?>
                ...
                <div class="modal fade" id="showcomment" role="dialog" hidden="">
                                ...
                                <table class="table table-striped">
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th width="40%">ผู้ดำเนินการ</th>
                                        </tr>
                                        </thead>
                                        <tbody id="show_comment">
