                            ...
                            <table id="table_permisoffer_staff_in_system" class="table table-striped table-bordered">
                                ...
                                foreach ($prosub_offer as $rows) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../detailpro/detailprostaff?id=<?= $rows['prosub_code'] ?>"><i
                                                        class="glyphicon glyphicon-eye-open"></i></a> | <a
                                                    href="../permission/permis-pronone-systemoffer-staff?id=<?= $rows['prosub_code'] ?>"><i
                                ...
                                foreach ($prosub_place as $key => $rows) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            |
                                            <a href="../permissionplace/permis-staff?id=<?= $rows['prosub_code'] ?>"><i
                                                        class="glyphicon glyphicon-check"></i></a>
                                        </td>
                                ...
                                foreach ($prosub_pandb as $key => $rows) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a><i class=""></i></a>
                                                <?php
                                                echo "<a href=\"../detailcompactpandb/detail-staff?id=" . $rows['prosub_code'] . "&compact=" . $rows['id'] . "\"><i class=\"glyphicon glyphicon-eye-open\"></i></a> ";
                                                echo " | <a href=\"../permissionpandb/permis-staff?id=" . $rows['prosub_code'] . "&compact=" . $rows['id'] . "\"><i class=\"glyphicon glyphicon-check\"></i></a> ";
                                                ?>
