...
<header id="page-header">
    <h1>โครงการที่เสนอลงปีงบประมาณ</h1>
    <?php
...
<!--                <a href="../addprosub/prosub-add" class="btn btn-success btn-3d btn-ms" data-dismiss="modal"><i class="glyphicon glyphicon-plus"></i> เพิ่มโครงการย่อย</a><br><br>-->
<!--            </div>-->
<!--        </div>-->
        <div class="row">
