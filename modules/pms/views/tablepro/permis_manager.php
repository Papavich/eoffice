                            ...
                            <table id="table_permisoffer_staff_in_system" class="table table-striped table-bordered">
                                ...
                                foreach ($prosub_offer as $rows) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../detailpro/detailpromanager?id=<?= $rows['prosub_code'] ?>"><i
                                                        class="glyphicon glyphicon-eye-open"></i></a> | <a
                                                    href="../permission/permis-pronone-systemoffer-manager?id=<?= $rows['prosub_code'] ?>"><i
                            ...
                            <table id="table_compact_place" class="table table-striped table-bordered">
                                ...
                                foreach ($prosub_place as $key => $rows) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            echo "<a href=\"../detailcompactplace/detail-manager?id=" . $rows['prosub_code'] . "\"><i class=\"glyphicon glyphicon-eye-open\"></i></a> ";
                                            ?>
                                            |
                                            <a href="../permissionplace/permis-manager?id=<?= $rows['prosub_code'] ?>"><i
                                                        class="glyphicon glyphicon-check"></i></a>
                                        </td>
                                ...
                                foreach ($prosub_pandb as $key => $rows) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a><i class=""></i></a>
                                                <?php
                                                echo "<a href=\"../detailcompactpandb/detail-manager?id=" . $rows['prosub_code'] . "&compact=" . $rows['id'] . "\"><i class=\"glyphicon glyphicon-eye-open\"></i></a> ";
                                                echo " | <a href=\"../permissionpandb/permis-manager?id=" . $rows['prosub_code'] . "&compact=" . $rows['id'] . "\"><i class=\"glyphicon glyphicon-check\"></i></a> ";
                                                ?>
