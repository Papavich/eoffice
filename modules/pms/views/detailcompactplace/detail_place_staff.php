    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <p><a href="#" data-toggle="modal" class="get_status_place" data="<?=$modelprosub->prosub_code?>" data-target="#showstatus">สถานะขออนุมัติจัดโครงการ</a> :
                ...
                ?>
                <?php
                if($modelprosub->prosub_status_place =="รอฝ่ายพัฒนานักศึกษาตรวจสอบ"){
                    echo "<a class=\"btn btn-sm btn-3d btn-info\" href=\"../permissionplace/permis-staff?id=".$modelprosub->prosub_code."\"><i class=\"fa fa-check\"> ตรวจสอบ</i></a> ";
                    echo " <a class=\"btn btn-sm btn-3d btn-warning\"ตรวจสอบ data-toggle=\"modal\" data-target=\"#notconfirmed\"><i class=\"glyphicon glyphicon-arrow-left\"></i> ส่งกลับแก้ไข</a>";
                }
                else if($modelprosub->prosub_status_place =="อนุมัติระบบสำเร็จ"){
