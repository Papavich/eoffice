    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <p><a href="#" data-toggle="modal" class="get_status_place" data="<?=$modelprosub->prosub_code?>" data-target="#showstatus">สถานะขออนุมัติจัดโครงการ</a> :
                ...
                ?>
                <?php
                if($modelprosub->prosub_status_place =="รองานนโยบายและแผนอนุมัติ"){
                    echo "<a class=\"btn btn-sm btn-3d btn-info\" href=\"../permissionplace/permis-planner?id=".$modelprosub->prosub_code."\"><i class=\"fa fa-check\"> อนุมัติ</i></a> ";
