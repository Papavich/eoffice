...
/**
 * This is the model class for table "view_pis_person".
 *
 ...
 */
class ViewPisPerson extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['person_current_address', 'person_email', 'major_name_eng', 'major_code', 'NATIONNAME', 'person_position_staff', 'DEPARTMENTNAME'], 'string', 'max' => 100],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'person_mobile' => 'เบอร์โทรติดต่อ',
            'person_email' => 'Person Email',
            'person_type' => 'Person Type',
            'person_fax' => 'Person Fax',
            'academic_positions_abb_thai' => 'ตำแหน่ง',
