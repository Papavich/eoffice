...
/**
 * EofficeExamInvigilateSearch represents the model behind the search form of `app\modules\eoffice_exam\models\EofficeExamInvigilate`.
 */
class EofficeExamInvigilateSearch extends EofficeExamInvigilate
{
    /**
     * @inheritdoc
     */
