    ...
    <div id="wrapper" class="clearfix">
        ...
        <header id="header">
            ...
            <span class="logo pull-left">
               <img src="<?= Yii::getAlias('@web') ?>/web_exam/images/exam_logo.png" alt="admin panel" height="45" />
           </span>
        ...
        <div id="panel-1" class="panel panel-default">
            <div class="panel-heading">
                  <span class="title elipsis">
                    <strong>Examination Management System</strong> <!-- panel title -->
                  </span>
