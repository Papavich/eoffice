    ...
    <div class="panel-body">
        <div style="padding-left: 280px;">
            <div class="row">
                <div class="col-md-6">
                    <?php
                     echo $form->Field($model, 'subopen_year')->textInput(['value'=>$subopen_year]);
                     ?>
                </div>
            </div>
        ...
        <div style="padding-left: 250px;">
          <div class="row">
            ...
            <div class="col-md-3">
                <input type="text" name="startDate" id="startDate" class="form-control datepicker" data-format="yyyy-mm-dd" data-lang="en" value='<?php echo $exam_detail_date_start;?>' data-RTL="false">
            </div>
