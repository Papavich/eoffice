...
// end count days
        ...
        for($days = 0 ; $days < $session['numberDays']; $days++ ) {
            ...
            $modelEnroll = Enroll::find()
                ->where(['exam_enroll_date' => $session['date']['' . $days]])
...
//            echo "<pre>";
//            print_r(array_count_values(array_column($AllEnroll,'SUBJECT_ID')));
//            echo "</pre>";
...
//            echo "</pre>";
            ...
            while ($subject = current($countEnroll)) {
                ...
                if ($countEnroll[key($countEnroll)] == 1) {
                    ...
                    $modelEnroll = Enroll::find()
                        ...
                        ->all();
                    foreach ($modelEnroll as $item) {
                        $sum = $sum + $item->exam_enroll_seat_temp;
                    }
            ...
            do {
                ...
                $AllRoom = $this->GetRoomA($days, $AllEnrollA[0]['TIME']);
            ...
            do {
                ...
                $AllRoom = $this->GetRoomB($days, $AllEnrollB[0]['TIME']);
            ...
            $AllExamination['' . $session['date'][$days]] = $Examination;
