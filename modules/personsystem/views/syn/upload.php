            ...
            <div class="panel-body" style="display: block;">
                <div class="row tabs nomargin">
                   <b>คำแนะนำในการนำเข้าไฟล์ Excel ลง Database</b><br>
                    ...
                    Username คือรหัสนักศึกษา Password คือรหัสประจำตัวประชาชน<br>
                </div>
            </div>
        </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <select  name="database"  class="form-control">
                                                ...
                                                <option value="reg_enroll">ENROLL</option>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <?= Html::submitButton(controllers::t('label','Save'),['class'=>'btn btn-3d btn-green','id'=>'submit']) ?>
                                        <?php ActiveForm::end(); ?>
                                    </div>
                                </div>
                            </div>
