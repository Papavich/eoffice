        ...
        <ul class="nav nav-tabs" style="margin-left: 14px;">
            ...
            <li class="<?php if (!empty($_GET["active"]) && $_GET["active"] == 4) {
                ...
                <a href="#tab4_nobg" data-toggle="tab">
                    <i class="fa fa-line-chart"></i> <?php echo controllers::t('label', 'Reset Password'); ?>
                </a>
            </li>
                            ...
                            <div id="smartwizard2">
                                ...
                                <ul>
                                    <li><a href="#step-1">
                                            <small>Step 1</small>
                                            <br/>
                                            <small><?= controllers::t('label', 'Teacher Information'); ?></small>
                                        </a></li>
                                    <li><a href="#step-2">
                                            <small>Step 2</small>
                                            <br/>
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6">
                                                                <?= $form->field($model, 'major_id')->dropDownList(GetModelController::getMajor(), ['maxlength' => true])->label(controllers::t('label', 'Lecturer')) ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <h4>
                                            <span style="color:#428bca;"><?= controllers::t('label', 'Add Expertise') ?></span>
                                        </h4>
                                    </div>
                            ...
                            <br>
                            <h4><span style="color:#428bca;"><?= controllers::t('label', 'Tabel Expertise') ?></span>
                            </h4>
                            <?= \yii\grid\GridView::widget([
