...
<header id="page-header">
    ...
    <a href="admin-update-staff?id=<?= $person ?>&active=2" class="btn btn-sm btn-default"><i class="fa fa-chevron-circle-left"></i> Back</a><br>
</header>
<div id="content" class="padding-20">
    ...
    <?php $form = ActiveForm::begin(['action'=>'edu-create']); ?>
    <div class="row">
        <div class="col-md-12">
