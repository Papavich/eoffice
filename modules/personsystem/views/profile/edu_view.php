...
<header id="page-header">
    ...
    <a href="<?=controllers\GetModelController::getType()?>?active=2" class="btn btn-sm btn-default"><i class="fa fa-chevron-circle-left"></i> Back</a><br>
</header>
<?= Html::csrfMetaTags() ?>
    <div id="content" class="padding-20">
        ...
        <?= Html::a(Yii::t('app', 'Delete'), ['edu-delete', 'id' => $model->history_education_id], [
