...
<header id="page-header">
    ...
    <a href="<?= Yii::getAlias('@web') ?>/site/index" class="btn btn-sm btn-default"><i
                class="fa fa-chevron-circle-left"></i> Back</a><br>
    <br>
</header>
<div id="content" class="padding-20">
    <div class="row">
        ...
        <ul class="nav nav-tabs" style="margin-left: 14px;">
            <li class="<?php if (empty($_GET["active"])) {
                echo "active";
            } ?>">
            ...
            <li class="<?php if (!empty($_GET["active"]) && $_GET["active"] == 3) {
                echo "active";
            } ?>">
                <a href="#tab3_nobg" data-toggle="tab">
                    <i class="fa fa-copy"></i> <?php echo controllers::t('label', 'Responsibility'); ?>
                </a>
            </li>
            <li class="<?php if (!empty($_GET["active"]) && $_GET["active"] == 4) {
                echo "active";
            } ?>">
        ...
        <div class="tab-content transparent">
            <div id="tab1_nobg" class="tab-pane <?php if (empty($_GET["active"])) {
                echo "active";
            } ?>">
                <!------------------------------------------- แถบ1 ----------------------------------------------------------------->
                <div class="col-md-12">
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            <div class="col-md-6 col-sm-6">
                                                                <?php
                                                                $person = \app\modules\personsystem\models\Person::findOne(\Yii::$app->user->identity->person_id);
                                        ...
                                        <div class="group-info">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        <br>
                                                        <?= Html::submitButton(controllers::t('label', 'Save'), ['class' => 'btn btn-block btn-success']) ?>
                                                        <?php ActiveForm::end(); ?>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div id="tab2_nobg" class="tab-pane <?php if (!empty($_GET["active"]) && $_GET["active"] == 2) {
                echo "active";
            } ?>">
                <!------------------------------------------- แถบ1 ----------------------------------------------------------------->
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body"><br>
                            <h4>
                                <span style="color:#428bca;"><?= controllers::t('label', 'Tabel History Education') ?></span>
                            </h4>
...
//                                    ],
                                    ...
                                    ['class' => 'yii\grid\ActionColumn',
                                        'buttons' => [
                                            ...
                                            'view' => function ($url, $model, $key) {
                                                return Html::a('<i class="glyphicon glyphicon-eye-open"></i>', ['edu-view', 'id' => $model->history_education_id]);
                                            },
                                            'update' => function ($url, $model, $key) {
                                                return Html::a('<i class="glyphicon glyphicon-pencil"></i>', ['edu-update', 'id' => $model->history_education_id,]);
                                            },
                                            'delete' => function ($url, $model, $key) {
                                                return Html::a('<i class="glyphicon glyphicon-trash"></i>', ['edu-delete', 'id' => $model->history_education_id], ['onClick' => 'return confirm("Are you sure you want to delete this item?")']);
                                            }
                                        ],
                                    ],
                                ],
                            ...
                            <div class="col-md-12" align="right">
                                <a href="edu-create" type="button" class="btn btn-success btn-3d"><i
                                            class="fa fa-plus-square"></i><?php echo controllers::t('label', 'Create'); ?>
                                </a><br><br>
                            </div>
                        </div>
                    </div>
            ...
            <div id="tab3_nobg" class="tab-pane <?php if (!empty($_GET["active"]) && $_GET["active"] == 3) {
                echo "active";
            } ?>">
                <!------------------------------------------- แถบ1 ----------------------------------------------------------------->
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body"><br>
                            <h4><span style="color:#428bca;"><?= controllers::t('label', 'Add Responsibility') ?></span>
                            </h4>

                            <div class="col-md-12">
                                <?php $form = ActiveForm::begin(['action' => 'staff-respon-create']); ?>
                                <?= $form->field($modelRespon, 'responsibility')->textInput(['maxlength' => true])->label(controllers::t('label', 'Responsibility')) ?>
                                <?= $form->field($modelRespon, 'person_id')->hiddenInput(['value' => \Yii::$app->user->identity->person_id], ['disabled' => 'disabled'])->label(false) ?>
                                <div class="form-group">
                            ...
                            <h4>
                                <span style="color:#428bca;"><?= controllers::t('label', 'Table Responsibility') ?></span>
                            </h4>

                            <?= \yii\grid\GridView::widget([
                                'dataProvider' => $dataProviderRespon,
                                //'filterModel' => $searchModelRespon,
                                'layout' => '{items}{summary}{pager}',
                                'tableOptions' => [
                                    'class' => 'table  table-bordered table-hover dataTable ',
                                ],
                                'columns' => [
                                    ['class' => 'yii\grid\SerialColumn'],
                                    [
                                        'header' => controllers::t('label', 'Responsibility'),
                                    ...
                                    ['class' => 'yii\grid\ActionColumn',
                                        ...
                                        'buttons' => [
                                            'data-method' => 'post',
                                            'delete' => function ($url, $model, $key) {
                                                return Html::a('&nbsp;<i class="glyphicon glyphicon-trash"></i>', ['staff-respon-delete', 'id' => $model->respon_id], ['onClick' => 'return confirm("Are you sure you want to delete this item?")']);
                                            }
                                        ],
                                    ],
                                ],
            ...
            <div id="tab4_nobg" class="tab-pane <?php if (!empty($_GET["active"]) && $_GET["active"] == 4) {
                echo "active";
            } ?>">
                <!------------------------------------------- แถบ4 ----------------------------------------------------------------->
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body"><br>
                            <h4><span style="color:#428bca;"><?= controllers::t('label', 'Reset Password') ?></span>
                            </h4>
                            ...
                            <div class="form-group">
                                <div class="col-md-6" align="right"><br/>
                                    <?= Html::submitButton(Yii::t('user', 'Save'), ['class' => 'btn btn-success', 'id' => 'btn1']) ?>
                                    <br>
                                </div>
                            </div>
                            <hr/>
