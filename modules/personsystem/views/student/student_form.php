                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <fieldset>
                                        ...
                                        <br>
                                        <h4><span style="color:#428bca;"><?php echo controllers::t('label','Skill'); ?></span></h4><hr>
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-12">
                                                    <?php //$form->field($modelStudentSkill, 'id_skill')->textarea(['maxlength' => true,])->label(controllers::t( 'label','Skill Programming')) ?>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            <?php if($model->student_img!=""){?>
                                                <img class="img-thumbnail" width="150" height="150" alt="" src="<?= Yii::getAlias('@web') ?>/web_personal/upload/System/<?= $model->student_img ?>" height="34" ALIGN=LEFT>
                                            <?php  }else{?>
