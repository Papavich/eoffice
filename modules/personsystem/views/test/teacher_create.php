                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <?= $form->field($model, 'person_gender')->dropDownList(['F' => 'หญิง', 'M' => 'ชาย'],['prompt'=> controllers::t( 'label',"Enter Gender")],['options' => [$model->person_gender => ['selected' => true]]],['maxlength' => true])->label(controllers::t('label','Gender')) ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                        <?= $form->field($model, 'major_id')->dropDownList(GetModelController::getMajor(),['prompt'=> controllers::t( 'label',"Enter Major ")],['maxlength' => true])->label(controllers::t('label','Lecturer')) ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <?= $form->field($model, 'person_marital_status')->dropDownList(['สมรส' => 'สมรส', 'โสด' => 'โสด', 'หย่าร้าง' => 'หย่าร้าง','หม้าย'=>'หม้าย'],['prompt'=> controllers::t('label','Enter Marital Status')],['options' => [$model->person_gender => ['selected' => true]]],['maxlength' => true])->label(controllers::t('label','Marital Status')) ?>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6">
                                                            <?= $form->field($model, 'person_group_blood')->dropDownList(['O' => 'O', 'A' => 'A', 'B' => 'B', 'AB' => 'AB'],['prompt'=> controllers::t('label','Enter Blood Group')],['maxlength' => true])->label(controllers::t('label','Blood Group')) ?>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <fieldset>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <?= $form->field($model, 'person_decommission_date')->widget(
                                                                ...
                                                                'options'=>['class'=>'form-control']
                                                            ])->label(controllers::t('label','Decommission Date')) ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <?= $form->field($model, 'person_pension_withdraw')->dropDownList([''=>'','เงินงบประมาณ'=>'เงินงบประมาณ','เงินรายได้'=>'เงินรายได้'],['maxlength' => true])->label(controllers::t('label','pension Withdraw')) ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?= $form->field($model, 'person_type')->hiddenInput(['value'=> '1'],['disabled' => 'disabled'])->label(false) ?>
                                            </fieldset>
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="col-md-12 col-sm-12">
