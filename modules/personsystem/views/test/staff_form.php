...
<header id="page-header">
    <h1>แบบฟอร์มแก้ไขเจ้าหน้าที่</h1>
    <ol class="breadcrumb">
        <li><a href="#">Forms</a></li>
        <li class="active">Form  Edit Infomation</li>
    </ol>
    <a href="admin-edit-staff-list" class="btn btn-sm btn-default"><i class="fa fa-chevron-circle-left"></i> Back</a><br>
</header>
                        ...
                        <div class="panel-body">
                            <div class="col-md-6">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <fieldset>
                                            <h4><span style="color:#428bca;"><?= controllers::t('label','Staff Information'); ?></span></h4><hr>
                                            <div class="row">
                                            ...
                                            <h4><span style="color:#428bca;"><?= controllers::t('label','Contact Information'); ?></span></h4><hr>
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field( $model, 'person_home_province' )
                                                            ->widget( Select2::classname(), [
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field( $model, 'person_home_amphur' )
                                                            ->widget( Select2::classname(), [
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field( $model, 'person_home_district' )
                                                            ->widget( Select2::classname(), [
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field( $model, 'person_home_zipcode' )
                                                            ->widget( Select2::classname(), [
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field( $model, 'person_current_province' )
                                                            ->widget( Select2::classname(), [
                                                                'data' => ArrayHelper::map( Province::find()->all(), 'PROVINCE_ID', 'PROVINCE_NAME' ),
                                                                'options' => ['placeholder' => controllers::t( 'label', 'Enter Province' )],
                                                                'pluginOptions' => [
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field( $model, 'person_current_amphur' )
                                                            ->widget( Select2::classname(), [
                                                                'data' => ArrayHelper::map( Amphur::find()->all(), 'AMPHUR_ID', 'AMPHUR_NAME' ),
                                                                'options' => ['placeholder' => controllers::t( 'label', 'Enter Amphur' )],
                                                                'pluginOptions' => [
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field( $model, 'person_current_district' )
                                                            ->widget( Select2::classname(), [
                                                                'data' => ArrayHelper::map( District::find()->all(), 'DISTRICT_ID', 'DISTRICT_NAME' ),
                                                                'options' => ['placeholder' => controllers::t( 'label', 'Enter District' )],
                                                                'pluginOptions' => [
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field( $model, 'person_current_zipcode' )
                                                            ->widget( Select2::classname(), [
                                                                'data' => ArrayHelper::map( Zipcode::find()->all(), 'ZIPCODE_ID', 'ZIPCODE' ),
                                                                'options' => ['placeholder' => controllers::t( 'label', 'Enter Zipcode' )],
                                                                'pluginOptions' => [
                                    ...
                                    <div class="panel-body">
                                        <fieldset>
                                            ...
                                            <div class="row">
                                                <div class="form-group">
                                                    <div class="col-md-12 col-sm-12">
                                                        <?php if($model->person_img){?>
                                                            <img width="150" height="150" alt="" src="<?= Yii::getAlias('@web') ?>/web_personal/upload/person/<?= $model->person_img ?>" height="34" ALIGN=LEFT>
                                                        <?php  }else{?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6">
                                                        <?= $form->field($model, 'person_decommission_date')->widget(
                                                            ...
                                                            'options'=>['class'=>'form-control']
                                                        ])->label(controllers::t('label','Decommission Staff Date')) ?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
...
//                                    ],
                                    ...
                                    ['class' => 'yii\grid\ActionColumn',
                                        'buttons'=>[
                                            ...
                                            'view' => function($url,$model,$key){
                                                return Html::a('<i class="glyphicon glyphicon-eye-open"></i>',['staff/edu-view','id'=>$model->history_education_id]);
                                            },
                                            'update' => function($url,$model,$key){
                                                return Html::a('<i class="glyphicon glyphicon-pencil"></i>',['staff/edu-update','id'=>$model->history_education_id,]);
                                            },
                                            'delete' => function($url,$model,$key){
                                                return Html::a('<i class="glyphicon glyphicon-trash"></i>',['staff/edu-delete','id'=>$model->history_education_id,'person'=>$model->person_id],['onClick' => 'return confirm("Are you sure you want to delete this item?")']);
                                            }
                                        ],
                                    ],
                                ],
            ...
            <div id="tab3_nobg" class="tab-pane <?php if(!empty($_GET["active"])&& $_GET["active"]==3){echo "active";} ?>">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body"><br>
                                    <h4><span style="color:#428bca;"><?= controllers::t('label','Add Responsibility') ?></span></h4>

                            <div class="col-md-12">
                                <?php $form = ActiveForm::begin(['action'=>'respon-create?id='.$model->person_id]); ?>
                                <?= $form->field($modelRespon, 'responsibility')->textInput(['maxlength' => true])->label(controllers::t('label','Responsibility')) ?>
                                <?= $form->field($modelRespon, 'person_id')->hiddenInput(['value'=> $model->person_id],['disabled' => 'disabled'])->label(false) ?>
                                <div class="form-group">
                                    <?= Html::submitButton(controllers::t('label', 'Save'), ['class' => 'btn btn-success btn-3d']) ?>
                                </div>
                                <?php ActiveForm::end(); ?>
                            </div>
                                        <h4><span style="color:#428bca;"><?= controllers::t('label','Table Responsibility') ?></span></h4>
                                        ...
                                        'columns' => [
                                            ...
                                            ['class' => 'yii\grid\ActionColumn',
                                                ...
                                                'buttons'=>[
                                                    'data-method' => 'post',
                                                    'delete' => function($url,$model,$key){
                                                        return Html::a('&nbsp;<i class="glyphicon glyphicon-trash"></i>',['staff/respon-delete','id'=>$model->respon_id,'person'=>$model->person_id],['onClick' => 'return confirm("Are you sure you want to delete this item?")']);
                                                    }
                                                ],
                                                ],
                                        ],
