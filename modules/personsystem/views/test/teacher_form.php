                                            ...
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <?= $form->field($model, 'person_pension_withdraw')->dropDownList(['เงินงบประมาณ'=>'เงินงบประมาณ','เงินรายได้'=>'เงินรายได้'],['prompt'=> controllers::t( 'label',"Enter Pension Withdraw")])->label(controllers::t('label','pension Withdraw')) ?>
                                                        </div>
                                                    </div>
                                                </div>
