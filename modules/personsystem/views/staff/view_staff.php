...
<header id="page-header">
    <h1><?= controllers::t('label','Staff Information'); ?></h1>
    <ol class="breadcrumb">
        <li><a href="#">Forms</a></li>
        <li class="active">Form  Add Infomation</li><br>
    </ol><br>
    <div class="row">
        <div class="col-md-6" ><br/>
                <a href="admin-edit-staff-list" class="btn btn-sm btn-default"><i class="fa fa-chevron-circle-left"></i> Back</a>
        </div>
        ...
        <div class="col-md-6" align="right">
            ...
            <?= Html::a(Yii::t('app', 'Update'), ['admin-update-staff', 'id' => $model->person_id], ['class' => 'btn btn-primary']) ?>
        </div>
    </div>
</header>
                                        ...
                                        <form class="validate"  data-toastr-position="top-right">
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6">
                                                            <label><b><?= controllers::t('label','Academic Ranks'); ?></b></label>
                                                            <div class="line" name="dept_name" >
                                                                <?php if($Academic!=NULL){ echo $Academic;}else{echo "<span style='color:red'>N/A</span>";} ?>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <label><b><?= controllers::t('label','Position Staff'); ?></b></label>
                                                            <div class="line" name="dept_name" >
                                                                <?= $model->person_position_staff; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6 col-sm-6">
                                                            <label><b><?= controllers::t('label','Department Name'); ?></b></label>
                                                ...
                                                <div class="line" name="nationality">
                                                    <?php echo $model->personNation->NATIONNAME;  ?>
                                                </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6">
                                                            ...
                                                            <div class="line" name="mobile_phone">
                                                                <?php echo $model->person_mobile;  ?>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <label><b><?php echo controllers::t('label','Fax Number'); ?></b></label>
                                                            <div class="line" name="fax_number">
                                                                <?php echo $model->person_fax;  ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6">
                                                            <label><b><?php echo controllers::t('label','Email'); ?></b></label>
                                                            <div class="line" name="person_email">
                                                                <?php echo $model->person_email;  ?>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-sm-6">
                                                            <label><b><?php echo controllers::t('label','Web Site'); ?></b></label>
                                                            <div class="line" name="personal_website">
                                                                <?php echo $model->person_website;  ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <form class="validate" data-toastr-position="top-right">
                                            <fieldset>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-6 col-sm-6">
                                                            <label><b><?php echo controllers::t('label','Position Director'); ?></b></label>
                                                            <div class="line">
                                                                <?php echo $model->person_salary;  ?>
                                                            </div>
                                                        </div>
                                                ...
                                                <br><h4><span style="color:#428bca;"><?php echo controllers::t('label','Responsibility'); ?></span></h4><hr>
                                                <div class="row">
                                                    <div class="form-group">
                                                        <div class="col-md-12 col-sm-12">
                                                            <div class="" name="expertise_field_name" value="- การพัฒนาโปรแกรมระดับองค์กรด้วย Java EE - API แบบเปิด, RESTful เว็บเซอร์วิส - การเขียนโปรแกรมภาษาจาวา">
                                                            <?php foreach ($modelRespon as $key=> $value){?>
                                                                <div>- <?= $value->responsibility ?></div>
                                                                <?php } ?>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive"><br>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    <?php   foreach ($modelEduca as $value){  ?>
                                        <tr>
