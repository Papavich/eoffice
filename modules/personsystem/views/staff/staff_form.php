...
<header id="page-header">
    ...
    <a href="admin-edit-staff-list" class="btn btn-sm btn-default"><i class="fa fa-chevron-circle-left"></i>
        Back</a><br>
</header>
...
//                                    ],
                            ...
                            <div class="col-md-12" align="right">
                                <a href="edu-create?person=<?= $model->person_id ?>" type="button"
                                   class="btn btn-success btn-3d"><i
