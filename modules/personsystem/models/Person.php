...
class Person extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['person_card_id', 'person_name', 'person_surname', 'person_citizen_id', 'prefix_id', 'person_email', 'person_type', 'department_id', 'faculty_id', 'person_religion_id', 'person_nation_id','academic_positions_id'], 'required'],
            ...
            [['faculty_id'], 'exist', 'skipOnError' => true, 'targetClass' => RegFaculty::className(), 'targetAttribute' => ['faculty_id' => 'FACULTYID']],
    ...
    public function upload($model,$attribute)
    {
        ...
        if ($this->validate() && $photo !== null) {
            $fileName = $model->person_id . "_" . $model->person_type . '.' . $photo->extension;
    ...
    {
        return $this->hasOne(RegFaculty::className(), ['FACULTYID' => 'faculty_id']);
    }
